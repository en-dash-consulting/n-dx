...
| Title | Status |
|-------|--------|
| [Diagnose timer-expiry auto-commit stall path in hench loop and identify blocking call site](./diagnose-timer-expiry-auto-3e8c3c.md) | in_progress |
| [Fix hench loop to treat timer-expiry auto-commit as a successful commit and advance to next task](./fix-hench-loop-to-treat-timer-e5c37f.md) | pending |
