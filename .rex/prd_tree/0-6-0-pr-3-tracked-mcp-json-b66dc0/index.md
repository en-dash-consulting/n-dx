...
startedAt: "2026-09-11T14:41:47.553Z"
completedAt: "2026-09-11T14:41:47.553Z"
endedAt: "2026-09-11T14:41:47.553Z"
acceptanceCriteria:
...
lastModified: "2026-09-11T14:41:47.561Z"
...
| Title | Status |
|-------|--------|
| [Codex .codex/config.toml uses the same cwd-relative MCP commands](./codex-codex-config-toml-uses-84ccf6.md) | completed |
| [Docs: rewrite the MCP registration section; mark HTTP registration as single-project](./docs-rewrite-the-mcp-9f0a2b.md) | completed |
| [ndx init stops writing local-scope MCP registrations by default and never removes user-scope entries](./ndx-init-stops-writing-local-e4df32.md) | completed |
| [ndx init writes a tracked .mcp.json with cwd-relative stdio commands for rex and sourcevision](./ndx-init-writes-a-tracked-mcp-97fbae.md) | completed |
| [Tests: init writes .mcp.json; generated MCP configs contain no absolute paths](./tests-init-writes-mcp-json-635922.md) | completed |
