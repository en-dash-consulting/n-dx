...
| Title | Status |
|-------|--------|
| [Audit all ndx CLI commands against web dashboard feature coverage and document gaps](./audit-all-ndx-cli-commands-against-web.md) | completed |
| [Implement dashboard trigger controls for CLI commands lacking UI representation](./implement-dashboard-trigger-controls.md) | completed |
