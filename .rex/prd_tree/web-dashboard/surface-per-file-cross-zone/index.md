...
| Title | Status |
|-------|--------|
| [Add tests for cross-zone connection surfacing and file ordering](./add-tests-for-cross-zone-connection.md) | completed |
| [Color-code the cross-zone indicator bar by target zone](./color-code-the-cross-zone-indicator.md) | completed |
| [Highlight a file's cross-zone connections on hover or select](./highlight-a-file-s-cross-zone.md) | completed |
| [Prioritize and optionally filter connecting files in an expanded zone](./prioritize-and-optionally-filter.md) | completed |
| [Show target zones per connecting file row](./show-target-zones-per-connecting-file.md) | completed |
