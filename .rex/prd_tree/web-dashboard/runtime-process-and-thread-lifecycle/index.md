...
| Title | Status |
|-------|--------|
| [Audit and enforce worker thread cleanup across all CLI entry points](./audit-and-enforce-worker-thread.md) | completed |
| [Implement orphan process detection and cleanup for spawned subcommands](./implement-orphan-process-detection-and.md) | completed |
