...
| Title | Status |
|-------|--------|
| [Build full-page N-eolithic dino animation overlay with dismiss interaction](./build-full-page-n-eolithic-dino.md) | completed |
| [Implement triple-click gesture detector with probabilistic trigger gate on the rex icon](./implement-triple-click-gesture.md) | completed |
