...
completedAt: "2026-08-14T17:45:43.031Z"
endedAt: "2026-08-14T17:45:43.031Z"
acceptanceCriteria:
...
| [Restore orphaned ZonesView and AnalysisView into navigation](./restore-orphaned-zonesview-and.md) | completed |
| [Tier 3 small coverage items](./tier-3-small-coverage-items.md) | completed |
| [Token usage depth and self-heal live view](./token-usage-depth-and-self-heal-live.md) | completed |
| [Validation view actions: rex fix, reshape, ndx ci triggers](./validation-view-actions-rex-fix.md) | completed |
