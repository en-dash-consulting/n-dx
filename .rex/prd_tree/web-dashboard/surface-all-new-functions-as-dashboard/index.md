...
| Title | Status |
|-------|--------|
| [Implement new dashboard pages/sections for uncovered functions](./implement-new-dashboard-pages-sections/index.md) | completed |
| [Audit functions lacking dashboard UI coverage](./audit-functions-lacking-dashboard-ui.md) | completed |
