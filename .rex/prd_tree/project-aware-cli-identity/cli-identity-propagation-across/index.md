...
status: "completed"
source: "smart-add"
startedAt: "2026-08-14T17:28:58.263Z"
completedAt: "2026-08-14T17:28:58.263Z"
endedAt: "2026-08-14T17:28:58.263Z"
acceptanceCriteria: []
...
| Title | Status |
|-------|--------|
| [Expose resolved CLI name via server API and inject into dashboard shared state](./expose-resolved-cli-name-via-server.md) | completed |
| [Replace hardcoded 'ndx' command references in dashboard UI with project-resolved CLI name](./replace-hardcoded-ndx-command.md) | completed |
