...
| Title | Status |
|-------|--------|
| [Detect project CLI name from package.json bin field and expose in .n-dx.json schema](./detect-project-cli-name-from-2238b4.md) | pending |
| [Propagate resolved CLI name into hench agent prompts and task briefs](./propagate-resolved-cli-name-7828db.md) | pending |
