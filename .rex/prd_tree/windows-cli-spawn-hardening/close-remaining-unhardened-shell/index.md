...
| Title | Status |
|-------|--------|
| [Harden claude-integration execSync sites and make the DEP0190 guard self-maintaining](./harden-claude-integration-execsync.md) | completed |
| [Make ndx export --deploy=github work on Windows (rm -rf and POSIX shell syntax)](./make-ndx-export-deploy-github-work-on.md) | completed |
