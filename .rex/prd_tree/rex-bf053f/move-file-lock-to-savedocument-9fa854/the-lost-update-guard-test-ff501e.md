...
tags:
  ...
  - "severity:high"
source: "ndx-capture"
startedAt: "2026-08-28T17:56:10.253Z"
completedAt: "2026-08-28T18:19:32.004Z"
endedAt: "2026-08-28T18:19:32.004Z"
resolutionType: "code-change"
resolutionDetail: "Real locking hole, not a test bound: syncFolderTree did an unlocked, unguarded load→serialize after each handler's transaction released the lock, silently deleting items written by writers queued behind it. Now holds the folder-tree lock across load+serialize and passes loadedAt (stamped before the load) so a bypassing writer fails loudly. Lock filename shared via PRD_TREE_LOCK_FILENAME. New deterministic tests in folder-tree-sync-lock.test.ts, verified red against the pre-fix code. Lock contention behaviour documented in acquireLock, withFileTransaction, and the monorepo concurrency contract."
acceptanceCriteria:
...
lastModified: "2026-08-28T18:19:32.035Z"
