...
startedAt: "2026-09-16T20:20:06.968Z"
completedAt: "2026-09-16T20:20:06.968Z"
endedAt: "2026-09-16T20:20:06.968Z"
acceptanceCriteria:
...
lastModified: "2026-09-16T20:20:07.348Z"
...
| Title | Status |
|-------|--------|
| [Dashboard writes go to the selected workspace's tree; editing the anchor while viewing a branch requires an explicit switch](./dashboard-writes-go-to-the-d95cab.md) | completed |
| [PRD delta versus the anchor computed server-side and exposed at /api/workspaces/:wt/prd-delta](./prd-delta-versus-the-anchor-8d5f33.md) | completed |
| [Workspaces Overview view: machine strip, one card per worktree with live run, PRD delta count and Open / Start working / Stop; new WORKSPACES sidebar section](./workspaces-overview-view-00669f.md) | completed |
