...
startedAt: "2026-09-17T00:55:40.006Z"
completedAt: "2026-09-17T00:55:40.006Z"
endedAt: "2026-09-17T00:55:40.006Z"
acceptanceCriteria:
...
lastModified: "2026-09-17T00:55:40.377Z"
...
| Title | Status |
|-------|--------|
| [Keep writing .n-dx-web.port in the project directory pointing at the hub so refresh --live-server and the reload signal work unchanged](./keep-writing-n-dx-web-port-in-b278c7.md) | completed |
| [ndx start resolves the repo via the git common dir, derives the project id, starts the hub if absent, registers and opens /p/:id/](./ndx-start-resolves-the-repo-via-3ef336.md) | completed |
| [ndx start stop unregisters the project; hub exits with its last project unless hub.keepAlive; status reports hub and project state](./ndx-start-stop-unregisters-the-9bc85b.md) | completed |
