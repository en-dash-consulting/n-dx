...
| Title | Status |
|-------|--------|
| [Confirm AC 7 of the freeze-verify-kill task: a POSIX CI run must actually execute the freeze policy green](./confirm-ac-7-of-the-freeze-50f241.md) | completed |
