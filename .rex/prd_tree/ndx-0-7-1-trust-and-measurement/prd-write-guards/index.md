...
completedAt: "2026-09-25T13:57:11.242Z"
endedAt: "2026-09-25T13:57:11.242Z"
acceptanceCriteria:
...
lastModified: "2026-09-25T13:57:13.460Z"
...
| [Detect an index.md whose Children table omits a child directory, after confirming whether it hides items](./detect-an-index-md-whose-children.md) | completed |
...
| [Keep worktree agents' MCP PRD writes in their own worktree when a local-scope registration pins another path](./keep-worktree-agents-mcp-prd-writes-in.md) | completed |
| [Make the repo slug invariant test import source and check the marker](./make-the-repo-slug-invariant-test.md) | completed |
| [Offer to migrate a non-conformant tree at the gate, and stop rather than continue](./offer-to-migrate-a-non-conformant-tree.md) | completed |
