...
lastModified: "2026-09-24T20:29:42.719Z"
...
| Title | Status |
|-------|--------|
| [Queue offered review findings when the reviewer cannot ask the operator](./queue-offered-review-findings-when-the.md) | pending |
| [Resume a CLI work session that ended waiting on a background command](./resume-a-cli-work-session-that-ended.md) | pending |
| [Resume the review session when it ends waiting instead of writing its report](./resume-the-review-session-when-it-ends.md) | pending |
