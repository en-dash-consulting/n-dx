...
| Title | Status |
|-------|--------|
| [createLLMClient and cli-provider accept a cwd and the Ask route passes ctx.projectDir](./createllmclient-and-cli-103013.md) | completed |
| [rex and sourcevision still spawn the vendor CLI without a cwd](./rex-and-sourcevision-still-5323b1.md) | completed |
