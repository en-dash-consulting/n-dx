...
| Title | Status |
|-------|--------|
| [Orientation pass and warm-parent fork wiring](./orientation-pass-and-warm-parent-fork.md) | completed |
| [Sequential session batching strategy (tasksPerSession)](./sequential-session-batching-strategy.md) | completed |
| [Session cache, adapter --fork-session flag, and session-strategy config keys](./session-cache-adapter-fork-session.md) | completed |
