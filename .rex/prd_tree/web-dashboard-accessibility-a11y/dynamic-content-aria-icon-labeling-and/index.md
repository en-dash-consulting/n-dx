...
| Title | Status |
|-------|--------|
| [Add ARIA live regions for real-time UI updates and label all icon-only interactive elements across the dashboard](./add-aria-live-regions-for-real-time-ui.md) | completed |
| [Integrate automated a11y regression tests into CI and document screen-reader compatibility](./integrate-automated-a11y-regression.md) | completed |
