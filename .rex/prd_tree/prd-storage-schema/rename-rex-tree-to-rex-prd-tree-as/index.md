...
| Title | Status |
|-------|--------|
| [Rename .rex/tree path constants and update all serializer/parser/store call sites](./rename-rex-tree-path-constants-and.md) | completed |
| [Update CLAUDE.md, README, and folder-tree schema docs to reference .rex/prd_tree](./update-claude-md-readme-and-folder.md) | completed |
