...
| Title | Status |
|-------|--------|
| [Include branch and file attribution in rex API and MCP status responses](./include-branch-and-file-attribution-in.md) | completed |
| [Render branch badges on PRD tree rows and add branch filter to toolbar](./render-branch-badges-on-prd-tree-rows.md) | completed |
