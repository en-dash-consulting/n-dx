...
| Title | Status |
|-------|--------|
| [Update CLI integration tests and add e2e pipeline test for folder-tree PRD commands](./update-cli-integration-tests-and-add.md) | completed |
| [Update PRDStore unit tests and add serializer/parser unit tests with folder-tree fixtures](./update-prdstore-unit-tests-and-add.md) | completed |
