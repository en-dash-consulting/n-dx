...
| Title | Status |
|-------|--------|
| [Merge branch-scoped PRD files into single canonical 'prd' file](./merge-branch-scoped-prd-files-into.md) | completed |
| [Update PRD storage tests for single-file 'prd' location](./update-prd-storage-tests-for-single.md) | completed |
