...
| Title | Status |
|-------|--------|
| [Implement shared legacy-PRD detection, backup, and migration helper](./implement-shared-legacy-prd-detection.md) | completed |
| [Surface clear user-facing migration notification across CLI, MCP, and dashboard](./surface-clear-user-facing-migration.md) | completed |
| [Wire legacy-PRD migration check into all PRD-touching command entry points](./wire-legacy-prd-migration-check-into.md) | completed |
