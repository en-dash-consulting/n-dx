...
| Title | Status |
|-------|--------|
| [Add folder-per-task structural migration pass to ndx reshape and ndx add](./add-folder-per-task-structural.md) | completed |
| [Snapshot .rex/prd_tree to a timestamped backup before structural migration](./snapshot-rex-prd-tree-to-a-timestamped.md) | completed |
