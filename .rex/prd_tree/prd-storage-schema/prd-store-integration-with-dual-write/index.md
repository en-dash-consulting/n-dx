...
| Title | Status |
|-------|--------|
| [Build automatic first-run migration and explicit rex migrate-to-md CLI command](./build-automatic-first-run-migration.md) | completed |
| [Integrate markdown as primary read/write format in PRDStore with JSON dual-write](./integrate-markdown-as-primary-read.md) | completed |
| [Write end-to-end and concurrency tests for markdown-primary PRD storage](./write-end-to-end-and-concurrency-tests.md) | completed |
