...
| Title | Status |
|-------|--------|
| [Design folder naming conventions, index.md content schema, and recursive summary contract for each PRD level](./design-folder-naming-conventions-index.md) | completed |
| [Implement folder-tree-to-PRD parser that aggregates index.md files into the PRD item tree](./implement-folder-tree-to-prd-parser.md) | completed |
| [Implement PRD-to-folder-tree serializer that writes nested directories with index.md files](./implement-prd-to-folder-tree.md) | completed |
