...
| Title | Status |
|-------|--------|
| [Implement branch-aware PRD file naming convention and git branch/commit resolution](./implement-branch-aware-prd-file-naming.md) | completed |
| [Implement PRD file discovery and selection logic within the .rex directory](./implement-prd-file-discovery-and.md) | completed |
