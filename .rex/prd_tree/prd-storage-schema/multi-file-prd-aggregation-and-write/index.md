...
| Title | Status |
|-------|--------|
| [Refactor PRDStore read operations to aggregate items across all PRD files](./refactor-prdstore-read-operations-to.md) | completed |
| [Refactor PRDStore write operations to route modifications to the owning PRD file](./refactor-prdstore-write-operations-to.md) | completed |
