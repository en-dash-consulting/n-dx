...
| Title | Status |
|-------|--------|
| [Implement automatic migration from single prd.json to branch-scoped multi-file format](./implement-automatic-migration-from.md) | completed |
| [Validate all CLI commands, MCP tools, and web dashboard against multi-file PRD backend](./validate-all-cli-commands-mcp-tools.md) | completed |
