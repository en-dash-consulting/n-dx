...
| Title | Status |
|-------|--------|
| [Add architecture-policy test enforcing prd.md is not read or written outside migration helper](./add-architecture-policy-test-enforcing.md) | completed |
| [Audit and remove all prd.md read fallbacks and write paths from ndx add and rex add pipelines](./audit-and-remove-all-prd-md-read.md) | completed |
