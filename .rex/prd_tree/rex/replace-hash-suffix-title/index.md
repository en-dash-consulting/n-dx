...
| Title | Status |
|-------|--------|
| [Implement LLM-driven rename resolution for conflicting sibling titles](./implement-llm-driven-rename-resolution.md) | completed |
| [Remove hash-suffix title disambiguation from rex add and reshape write paths](./remove-hash-suffix-title.md) | completed |
| [Route true title-conflict duplicates through existing reshape merge rules](./route-true-title-conflict-duplicates.md) | completed |
