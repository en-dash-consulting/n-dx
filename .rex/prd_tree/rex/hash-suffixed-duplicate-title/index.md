...
| Title | Status |
|-------|--------|
| [Auto-trigger reshape consolidation pass after ndx add and rex add](./auto-trigger-reshape-consolidation.md) | completed |
| [Consolidate hash-suffixed duplicates with child reassignment and body merge](./consolidate-hash-suffixed-duplicates.md) | completed |
| [Implement hash-suffix-aware duplicate title detector for reshape consolidation](./implement-hash-suffix-aware-duplicate.md) | completed |
