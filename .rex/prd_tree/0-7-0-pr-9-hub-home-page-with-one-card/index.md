...
| Title | Status |
|-------|--------|
| [Hub home page: project cards fed from each child's status route, chooser at / when several projects are registered](./hub-home-page-project-cards-fed-from.md) | completed |
