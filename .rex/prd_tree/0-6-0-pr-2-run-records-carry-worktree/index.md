...
| [cli-start-two-projects asserts the exact relocation port, which is environment-fragile](./cli-start-two-projects-asserts-the.md) | completed |
| [findRelocationPort's near window is unclamped, so a peer on port 65535 crashes ndx start](./findrelocationport-s-near-window-is.md) | completed |
