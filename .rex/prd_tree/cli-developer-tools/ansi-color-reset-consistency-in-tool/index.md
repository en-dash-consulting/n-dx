...
| Title | Status |
|-------|--------|
| [Add regression tests for ANSI color reset and line-boundary consistency](./add-regression-tests-for-ansi-color.md) | completed |
| [Audit and fix missing ANSI reset codes in tool and CLI output lines](./audit-and-fix-missing-ansi-reset-codes.md) | completed |
