...
| Title | Status |
|-------|--------|
| [Add regression tests asserting stale-setup notice fires only on missing tool directories](./add-regression-tests-asserting-stale.md) | completed |
| [Replace stale-setup trigger with direct existence check for .sourcevision, .rex, and .hench folders](./replace-stale-setup-trigger-with.md) | completed |
