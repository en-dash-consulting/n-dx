...
| Title | Status |
|-------|--------|
| [Add regression tests verifying per-skill commit behavior and hench path isolation](./add-regression-tests-verifying-per.md) | completed |
| [Audit and classify all n-dx Claude Code skills by mutation footprint](./audit-and-classify-all-n-dx-claude.md) | completed |
| [Implement terminal auto-commit step in each file-modifying external skill](./implement-terminal-auto-commit-step-in.md) | completed |
