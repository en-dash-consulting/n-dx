...
| Title | Status |
|-------|--------|
| [Audit current animation frames against Rex-F.png and identify divergences](./audit-current-animation-frames-against.md) | completed |
| [Establish Rex-F.png as the canonical first animation frame](./establish-rex-f-png-as-the-canonical.md) | completed |
| [Source subsequent animation frames from nearest reference images and update sequence](./source-subsequent-animation-frames.md) | completed |
