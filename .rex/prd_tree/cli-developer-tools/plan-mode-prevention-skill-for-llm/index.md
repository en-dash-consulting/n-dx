...
| Title | Status |
|-------|--------|
| [Author plan-mode prevention skill definition with explicit no-plan-mode invariant](./author-plan-mode-prevention-skill.md) | completed |
| [Wire plan-mode prevention skill into hench agent prompt assembly and add regression coverage](./wire-plan-mode-prevention-skill-into.md) | completed |
