...
status: "completed"
priority: "high"
startedAt: "2026-09-08T18:11:14.047Z"
completedAt: "2026-09-08T18:21:24.707Z"
endedAt: "2026-09-08T18:21:24.707Z"
resolutionType: "code-change"
resolutionDetail: "The gitignore half was already done (f0cf5d3b, with tests). Implemented the task's second half: the pre-run gate and the rollback check now exclude hench's own runtime artifacts directly, so the fix no longer depends on a .gitignore entry that older projects lack. Path list shared as HENCH_RUNTIME_ARTIFACTS so init and the gate cannot drift; .hench/config.json deliberately still counts. Real-repo verification exposed that git collapses untracked directories to `?? .hench/`, defeating prefix matching — fixed with --untracked-files=all, which also makes the file count honest. Both stubbed and real-repo tests added."
acceptanceCriteria: []
...
lastModified: "2026-09-08T18:21:24.732Z"
