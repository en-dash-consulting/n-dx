...
| Title | Status |
|-------|--------|
| [Inline single-use pass-through wrapper functions in production source files](./inline-single-use-pass-through-wrapper.md) | completed |
| [Remove single-symbol re-export modules and collapse intermediate barrel indirection](./remove-single-symbol-re-export-modules.md) | completed |
