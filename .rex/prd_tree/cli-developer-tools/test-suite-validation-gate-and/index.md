...
| Title | Status |
|-------|--------|
| [Implement test-failure remediation sub-loop in self-heal](./implement-test-failure-remediation-sub.md) | completed |
| [Integrate full test suite runner as a mandatory self-heal gate step](./integrate-full-test-suite-runner-as-a.md) | completed |
