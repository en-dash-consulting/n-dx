...
| Title | Status |
|-------|--------|
| [Inventory duplicated unit-test constants across suites](./inventory-duplicated-unit-test.md) | completed |
| [Update unit test callers to use shared utilities](./update-unit-test-callers-to-use-shared.md) | completed |
| [Validate behavioral equivalence after test utility extraction](./validate-behavioral-equivalence-after.md) | completed |
