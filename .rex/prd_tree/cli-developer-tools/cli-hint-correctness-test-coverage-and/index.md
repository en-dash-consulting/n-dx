...
| Title | Status |
|-------|--------|
| [Add regression tests that verify hint surfacing and follow-through correctness](./add-regression-tests-that-verify-hint.md) | completed |
| [Audit and repair CLI hint text across all commands](./audit-and-repair-cli-hint-text-across.md) | completed |
| [Synchronize project documentation with current CLI command surface](./synchronize-project-documentation-with.md) | completed |
| [Update cli-brand.test.js snapshot to match redesigned ndx init dinosaur](./update-cli-brand-test-js-snapshot-to.md) | completed |
