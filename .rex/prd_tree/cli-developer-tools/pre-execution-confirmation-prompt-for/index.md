...
| Title | Status |
|-------|--------|
| [Add interactive task-approval prompt to ndx self-heal before execution begins](./add-interactive-task-approval-prompt.md) | completed |
| [Wire --auto/--yes flags and selfHeal.autoConfirm config to bypass the prompt](./wire-auto-yes-flags-and-selfheal.md) | completed |
