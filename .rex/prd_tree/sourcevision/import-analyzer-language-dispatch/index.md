...
| Title | Status |
|-------|--------|
| [Modify imports.ts to route .go files to the Go import parser](./modify-imports-ts-to-route-go-files-to.md) | completed |
| [Write integration tests validating the Go import graph against the fixture project](./write-integration-tests-validating-the.md) | completed |
