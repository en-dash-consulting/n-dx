...
| Title | Status |
|-------|--------|
| [Document Go zone detection behavior, edge semantics, and known limitations](./document-go-zone-detection-behavior.md) | completed |
| [Write end-to-end zone detection integration test for the Go fixture](./write-end-to-end-zone-detection.md) | completed |
