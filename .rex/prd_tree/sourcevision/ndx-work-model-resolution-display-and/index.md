...
| Title | Status |
|-------|--------|
| [Fix observation in global: Bidirectional coupling: "web" ↔ "web-server" (85+5 crossings) — consider extract](./fix-observation-in-global.md) | completed |
| [Implement vendor-change model reset to prevent cross-vendor stale config](./implement-vendor-change-model-reset-to.md) | completed |
