...
| Title | Status |
|-------|--------|
| [Audit and compact sourcevision LLM prompt templates](./audit-and-compact-sourcevision-llm.md) | completed |
| [Simplify and compact sourcevision analysis code for readability and reduced context size](./simplify-and-compact-sourcevision.md) | completed |
| [Trim and deduplicate LLM data payloads in sourcevision analysis](./trim-and-deduplicate-llm-data-payloads.md) | completed |
