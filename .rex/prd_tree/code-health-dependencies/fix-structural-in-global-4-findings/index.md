...
| Title | Status |
|-------|--------|
| [Fix structural in global: Both rex fix zones fall at or below the dual-fragility threshold simultaneously; (+3 more)](./fix-structural-in-global-both-rex-fix.md) | completed |
