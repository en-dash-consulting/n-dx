...
| Title | Status |
|-------|--------|
| [Fix structural in theme-toggle: Single-file micro-zone with cohesion 0 and coupling 1 — an algorithmic artifact.](./fix-structural-in-theme-toggle-single.md) | completed |
