...
| Title | Status |
|-------|--------|
| [Fix code in project-scaffold: cli-brand.js exists at both the repo root and inside packages/core, creating a d](./fix-code-in-project-scaffold-cli-brand.md) | completed |
