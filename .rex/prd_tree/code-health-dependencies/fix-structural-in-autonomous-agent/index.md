...
| Title | Status |
|-------|--------|
| [Fix structural in autonomous-agent-engine: No automated intra-zone boundary assertions exist yet; at 208 files the zone is ](./fix-structural-in-autonomous-agent.md) | completed |
