...
| Title | Status |
|-------|--------|
| [Fix code in task-usage-scheduler: start.ts satisfies RegisterSchedulerOptions by passing a concrete options litera (+2 more)](./fix-code-in-task-usage-scheduler-start.md) | completed |
