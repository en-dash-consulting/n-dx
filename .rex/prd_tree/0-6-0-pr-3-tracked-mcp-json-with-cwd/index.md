...
| [Docs: rewrite the MCP registration section; mark HTTP registration as single-project](./docs-rewrite-the-mcp-registration.md) | completed |
...
| [Tests: init writes .mcp.json; generated MCP configs contain no absolute paths](./tests-init-writes-mcp-json-generated.md) | completed |
