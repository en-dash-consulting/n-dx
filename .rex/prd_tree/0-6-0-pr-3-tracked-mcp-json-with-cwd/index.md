...
| [Docs: rewrite the MCP registration section; mark HTTP registration as single-project](./docs-rewrite-the-mcp-registration.md) | deferred |
| [ndx init stops writing local-scope MCP registrations by default and never removes user-scope entries](./ndx-init-stops-writing-local-scope-mcp.md) | deferred |
...
| [Tests: init writes .mcp.json; generated MCP configs contain no absolute paths](./tests-init-writes-mcp-json-generated.md) | deferred |
