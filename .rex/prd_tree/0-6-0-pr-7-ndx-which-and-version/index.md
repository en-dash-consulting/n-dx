...
| Title | Status |
|-------|--------|
| [Dashboard footer shows server version, install path and served project directory](./dashboard-footer-shows-server-version.md) | completed |
...
| [ndx work prints an identity line at start: version, cli path, project dir, branch](./ndx-work-prints-an-identity-line-at.md) | completed |
