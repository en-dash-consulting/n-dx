...
startedAt: "2026-09-11T13:43:01.992Z"
completedAt: "2026-09-11T13:43:01.992Z"
endedAt: "2026-09-11T13:43:01.992Z"
acceptanceCriteria:
...
lastModified: "2026-09-11T13:43:01.999Z"
...
| Title | Status |
|-------|--------|
| [Bind-unavailable runs report four passing no-op tests in cli-start-two-projects](./bind-unavailable-runs-report-e40e04.md) | completed |
| [classifyPortOccupant compares paths lexically, so a symlinked project path starts a second dashboard on the same PRD tree](./classifyportoccupant-compares-651e79.md) | completed |
| [E2E test: two project directories start dashboards concurrently without killing each other](./e2e-test-two-project-7bc1bb.md) | completed |
| [killPortOccupant SIGKILLs any process holding a socket on the port, not just the listener](./killportoccupant-sigkills-any-eee179.md) | completed |
| [Peer relocation ignores an explicitly requested port outside 3117–3200](./peer-relocation-ignores-an-38a307.md) | completed |
| [Probe the port occupant before killing it and fall back to a free port when it is another n-dx server](./probe-the-port-occupant-before-a9a209.md) | completed |
| [readWebVersion memoizes its own failure, pinning the reported version to "unknown"](./readwebversion-memoizes-its-own-0e20da.md) | completed |
| [server.version and server.cliPath assertions are tautological, so a silent "unknown" version ships green](./server-version-and-server-a1c9fe.md) | completed |
| [Status route reports served projectDir, server version, CLI path, pid and port](./status-route-reports-served-b41d7f.md) | completed |
