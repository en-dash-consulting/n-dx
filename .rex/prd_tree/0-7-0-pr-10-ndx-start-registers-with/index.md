...
| Title | Status |
|-------|--------|
| [Keep writing .n-dx-web.port in the project directory pointing at the hub so refresh --live-server and the reload signal work unchanged](./keep-writing-n-dx-web-port-in-the.md) | completed |
...
| [ndx start stop unregisters the project; hub exits with its last project unless hub.keepAlive; status reports hub and project state](./ndx-start-stop-unregisters-the-project.md) | completed |
