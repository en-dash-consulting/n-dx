...
| [ndx start resolves the repo via the git common dir, derives the project id, starts the hub if absent, registers and opens /p/:id/](./ndx-start-resolves-the-repo-via-the.md) | in_progress |
