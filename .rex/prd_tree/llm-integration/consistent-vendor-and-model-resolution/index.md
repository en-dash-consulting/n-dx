...
| Title | Status |
|-------|--------|
| [Implement centralized vendor/model resolver with newest-model default](./implement-centralized-vendor-model.md) | completed |
| [Propagate resolved vendor/model uniformly to all LLM call sites](./propagate-resolved-vendor-model.md) | completed |
| [Surface active vendor and model in ndx console output](./surface-active-vendor-and-model-in-ndx.md) | completed |
