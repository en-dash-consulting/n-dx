...
| Title | Status |
|-------|--------|
| [Audit Codex token validation and budget-check call sites within the hench work run loop](./audit-codex-token-validation-and.md) | completed |
| [Refactor Codex token accumulation to defer validation and reporting until run completion](./refactor-codex-token-accumulation-to.md) | completed |
