...
| Title | Status |
|-------|--------|
| [Add llm.autoFailover config flag with schema, loader, and ndx config surface](./add-llm-autofailover-config-flag-with.md) | completed |
| [Define vendor-specific failover chains and selection policy in llm-client](./define-vendor-specific-failover-chains.md) | completed |
| [Integrate failover loop into hench run with original-config restore and error parity](./integrate-failover-loop-into-hench-run.md) | completed |
