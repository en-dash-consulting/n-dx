...
| Title | Status |
|-------|--------|
| [Add explicit resolveVendorModel and vendor/model header to reshape, reorganize, and prune commands](./add-explicit-resolvevendormodel-and.md) | completed |
| [Replace hardcoded model defaults in sourcevision analyze with centralized resolveVendorModel](./replace-hardcoded-model-defaults-in.md) | completed |
