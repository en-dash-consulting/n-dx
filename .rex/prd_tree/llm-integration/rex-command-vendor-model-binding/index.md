...
| Title | Status |
|-------|--------|
| [Add regression tests for vendor-scoped model selection in rex commands](./add-regression-tests-for-vendor-scoped.md) | completed |
| [Audit rex LLM call sites for vendor/model resolver gaps](./audit-rex-llm-call-sites-for-vendor.md) | completed |
| [Fix rex commands to use resolved GPT model when vendor is codex](./fix-rex-commands-to-use-resolved-gpt.md) | completed |
