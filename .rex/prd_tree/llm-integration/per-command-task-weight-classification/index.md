...
| Title | Status |
|-------|--------|
| [Add unit and integration tests for weight-aware model resolution across packages](./add-unit-and-integration-tests-for.md) | completed |
| [Surface active model tier in vendor header output and log task weight reasoning](./surface-active-model-tier-in-vendor.md) | completed |
| [Wire light-tier model selection into rex smart-add and lightweight analysis paths](./wire-light-tier-model-selection-into.md) | completed |
