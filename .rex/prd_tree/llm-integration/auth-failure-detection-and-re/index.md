...
status: "completed"
source: "smart-add"
startedAt: "2026-07-20T16:48:10.783Z"
completedAt: "2026-07-20T16:48:10.783Z"
endedAt: "2026-07-20T16:48:10.783Z"
acceptanceCriteria: []
...
| Title | Status |
|-------|--------|
| [Add ndx auth check command and credential verification surface](./add-ndx-auth-check-command-and.md) | completed |
| [Classify 401 and authentication errors from LLM provider preflight as a distinct typed error](./classify-401-and-authentication-errors.md) | completed |
| [Surface concise re-authentication guidance when provider auth fails](./surface-concise-re-authentication.md) | completed |
