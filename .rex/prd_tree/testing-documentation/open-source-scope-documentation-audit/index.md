...
| Title | Status |
|-------|--------|
| [Add OPEN_SOURCE_SCOPE.md references to README and key documentation pages](./add-open-source-scope-md-references-to.md) | completed |
| [Audit and update OPEN_SOURCE_SCOPE.md against current codebase state](./audit-and-update-open-source-scope-md.md) | completed |
