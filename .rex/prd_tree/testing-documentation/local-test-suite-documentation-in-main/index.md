...
| Title | Status |
|-------|--------|
| [Add Local Platform Testing section to main README with prerequisites and run commands](./add-local-platform-testing-section-to.md) | completed |
| [Update .local_testing/README.md to cover macOS suite and unify platform guidance](./update-local-testing-readme-md-to.md) | completed |
