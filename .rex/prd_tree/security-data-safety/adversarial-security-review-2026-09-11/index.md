...
| [Gemini provider sends the API key in the URL query string](./gemini-provider-sends-the-api-key-in.md) | completed |
...
| [Web server `readBody` has no request-size cap](./web-server-readbody-has-no-request.md) | completed |
| [WebSocket upgrade accepts any Origin — dashboard broadcasts readable cross-site](./websocket-upgrade-accepts-any-origin.md) | completed |
