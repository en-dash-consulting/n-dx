...
| Title | Status |
|-------|--------|
| [Add integration tests for Ctrl-C interrupt and rollback prompt interaction](./add-integration-tests-for-ctrl-c.md) | completed |
| [Suspend custom SIGINT handler during rollback confirmation prompt](./suspend-custom-sigint-handler-during.md) | completed |
