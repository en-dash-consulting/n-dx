...
| Title | Status |
|-------|--------|
| [Intercept SIGINT during hench run loop and transition to graceful cancellation state](./intercept-sigint-during-hench-run-loop.md) | completed |
| [Show rollback prompt on Ctrl+C cancellation and reset PRD task status](./show-rollback-prompt-on-ctrl-c.md) | completed |
