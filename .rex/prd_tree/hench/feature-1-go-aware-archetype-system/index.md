...
| Title | Status |
|-------|--------|
| [Implement language-scoped ArchetypeSignal schema and add Go signals to archetypes](./implement-language-scoped.md) | completed |
| [Write archetype classification tests for Go projects](./write-archetype-classification-tests.md) | completed |
