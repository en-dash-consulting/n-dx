...
| Title | Status |
|-------|--------|
| [Hold first Ctrl+C during rollback prompt and require second Ctrl+C to exit](./hold-first-ctrl-c-during-rollback.md) | completed |
| [Print '=== Iteration n/total ===' banner between hench run loop iterations](./print-iteration-n-total-banner-between.md) | completed |
