...
| Title | Status |
|-------|--------|
| [Detect plan-only completions and re-prompt the agent to execute before allowing run completion](./detect-plan-only-completions-and-re.md) | completed |
| [Strengthen task-completion criteria to require evidence of code changes for code-classified tasks](./strengthen-task-completion-criteria-to.md) | completed |
