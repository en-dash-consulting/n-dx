...
| Title | Status |
|-------|--------|
| [Add regression tests for --loop consecutive-failure auto-cancellation](./add-regression-tests-for-loop.md) | completed |
| [Implement consecutive-failure counter and 3-strike auto-cancel in --loop mode](./implement-consecutive-failure-counter.md) | completed |
