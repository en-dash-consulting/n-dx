...
| Title | Status |
|-------|--------|
| [Diagnose and fix changed-file capture so run records reflect actual commit diffs](./diagnose-and-fix-changed-file-capture.md) | completed |
| [Render accurate changed-file counts and details in dashboard run summary](./render-accurate-changed-file-counts.md) | completed |
