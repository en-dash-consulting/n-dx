...
| Title | Status |
|-------|--------|
| [Diagnose timer-expiry auto-commit stall path in hench loop and identify blocking call site](./diagnose-timer-expiry-auto-commit.md) | completed |
| [Fix hench loop to treat timer-expiry auto-commit as a successful commit and advance to next task](./fix-hench-loop-to-treat-timer-expiry.md) | completed |
