...
| [Changeset and cross-shell validation](./changeset-and-cross-shell-8f067d.md) | completed |
...
| [Harden execShellCmd for Windows — `sh -c` is unresolvable outside Git Bash](./harden-execshellcmd-for-windows-724222.md) | completed |
