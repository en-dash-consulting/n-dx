...
| Title | Status |
|-------|--------|
| [Add regression tests for Google API key validation across config and init paths](./add-regression-tests-for-google-315102.md) | pending |
| [Diagnose and fix Google API key format validation rejecting valid keys](./diagnose-and-fix-google-api-key-edd062.md) | in_progress |
