...
| Title | Status |
|-------|--------|
| [Audit current animation frames against Rex-F.png and identify divergences](./audit-current-animation-frames-against-536c72d7/index.md) | completed |
| [Establish Rex-F.png as the canonical first animation frame](./establish-rex-fpng-as-the-canonical-42b353ce/index.md) | completed |
| [Source subsequent animation frames from nearest reference images and update sequence](./source-subsequent-animation-frames-from-3788d2a4/index.md) | completed |
