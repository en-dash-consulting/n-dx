...
| Title | Status |
|-------|--------|
| [Refactor PRDStore read operations to aggregate items across all PRD files](./refactor-prdstore-read-operations-to-0d771f43/index.md) | completed |
| [Refactor PRDStore write operations to route modifications to the owning PRD file](./refactor-prdstore-write-operations-to-88f3b468/index.md) | completed |
