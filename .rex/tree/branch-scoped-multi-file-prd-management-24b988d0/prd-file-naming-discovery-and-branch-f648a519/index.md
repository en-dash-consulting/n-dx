...
| Title | Status |
|-------|--------|
| [Implement branch-aware PRD file naming convention and git branch/commit resolution](./implement-branch-aware-prd-file-naming-e7e01442/index.md) | completed |
| [Implement PRD file discovery and selection logic within the .rex directory](./implement-prd-file-discovery-and-8be8d4fd/index.md) | completed |
