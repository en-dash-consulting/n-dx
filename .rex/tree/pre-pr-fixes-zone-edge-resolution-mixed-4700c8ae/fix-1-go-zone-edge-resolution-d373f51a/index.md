...
| Title | Status |
|-------|--------|
| [Implement Go directory-to-files resolver and update zone pipeline](./implement-go-directory-to-files-9c28061d/index.md) | completed |
| [Add test coverage for Go zone edge resolution](./add-test-coverage-for-go-zone-edge-95dde960/index.md) | completed |
