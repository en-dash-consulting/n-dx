...
| [Strengthen task-completion criteria to require evidence of code changes for code-classified tasks](./strengthen-task-completion-criteria-to-require-bad1ef/index.md) | completed |
