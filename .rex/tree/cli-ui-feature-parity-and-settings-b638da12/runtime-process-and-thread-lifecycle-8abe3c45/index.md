...
| Title | Status |
|-------|--------|
| [Audit and enforce worker thread cleanup across all CLI entry points](./audit-and-enforce-worker-thread-cleanup-b1dc5843/index.md) | completed |
| [Implement orphan process detection and cleanup for spawned subcommands](./implement-orphan-process-detection-and-4e870c51/index.md) | completed |
