...
| Title | Status |
|-------|--------|
| [Audit all ndx CLI commands against web dashboard feature coverage and document gaps](./audit-all-ndx-cli-commands-against-web-400f7e1e/index.md) | completed |
| [Implement dashboard trigger controls for CLI commands lacking UI representation](./implement-dashboard-trigger-controls-5320dc1b/index.md) | completed |
