...
| Title | Status |
|-------|--------|
| [Suspend custom SIGINT handler during rollback confirmation prompt](./suspend-custom-sigint-handler-during-5cfeee22/index.md) | completed |
| [Add integration tests for Ctrl-C interrupt and rollback prompt interaction](./add-integration-tests-for-ctrl-c-20bbb688/index.md) | completed |
