...
| Title | Status |
|-------|--------|
| [Implement centralized vendor/model resolver with newest-model default](./implement-centralized-vendor-model-resolver-with-d9eaeb/index.md) | completed |
| [Propagate resolved vendor/model uniformly to all LLM call sites](./propagate-resolved-vendor-model-uniformly-to-all-abcdda/index.md) | completed |
| [Surface active vendor and model in ndx console output](./surface-active-vendor-and-model-in-ndx-console-output/index.md) | completed |
