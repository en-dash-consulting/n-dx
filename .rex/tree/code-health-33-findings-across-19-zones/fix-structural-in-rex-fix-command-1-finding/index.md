...
| Title | Status |
|-------|--------|
| [Fix structural in rex-fix-command: src/core/fix.ts is separated from the src/fix/ entry point by an artificial dire](./fix-structural-in-rex-fix-command-src-core-fix-ts-b2b443/index.md) | completed |
