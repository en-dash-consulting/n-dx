...
| Title | Status |
|-------|--------|
| [Aggregate durations up the PRD tree and expose alongside token usage](./aggregate-durations-up-the-prd-tree-and-expose-8f8ab3/index.md) | completed |
| [Record task start and end timestamps from hench runs and status transitions](./record-task-start-and-end-timestamps-from-hench-89bd6c/index.md) | completed |
