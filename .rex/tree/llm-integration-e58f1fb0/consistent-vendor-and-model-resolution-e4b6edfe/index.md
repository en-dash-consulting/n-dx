...
| Title | Status |
|-------|--------|
| [Implement centralized vendor/model resolver with newest-model default](./implement-centralized-vendormodel-d9eaeb4f/index.md) | completed |
| [Propagate resolved vendor/model uniformly to all LLM call sites](./propagate-resolved-vendormodel-abcddab7/index.md) | completed |
| [Surface active vendor and model in ndx console output](./surface-active-vendor-and-model-in-ndx-08f6d0b0/index.md) | completed |
