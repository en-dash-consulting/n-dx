...
| Title | Status |
|-------|--------|
| [Add regression tests asserting no JSON writes occur outside ndx start](./add-regression-tests-asserting-no-json-writes-occur-67246c/index.md) | completed |
| [Audit and remove residual JSON write calls from rex CLI and MCP handlers](./audit-and-remove-residual-json-write-calls-from-rex-eb208a/index.md) | completed |
| [Remove JSON dual-write from PRDStore save operations](./remove-json-dual-write-from-prdstore-save-operations/index.md) | completed |
