...
| Title | Status |
|-------|--------|
| [Add regression tests for vendor-scoped model selection in rex commands](./add-regression-tests-for-vendor-scoped-model-0270df/index.md) | completed |
| [Audit rex LLM call sites for vendor/model resolver gaps](./audit-rex-llm-call-sites-for-vendor-model-resolver-gaps/index.md) | completed |
| [Fix rex commands to use resolved GPT model when vendor is codex](./fix-rex-commands-to-use-resolved-gpt-model-when-f0c313/index.md) | completed |
