...
| Title | Status |
|-------|--------|
| [Add MacOS pipeline stage for ndx install-and-run smoke validation](./add-macos-pipeline-stage-for-ndx-install-and-run-d10a17/index.md) | completed |
| [Add Windows pipeline stage for ndx install-and-run smoke validation](./add-windows-pipeline-stage-for-ndx-install-and-run-1a72b5/index.md) | completed |
| [Implement cross-platform parity assertions for deterministic CLI responses](./implement-cross-platform-parity-assertions-for-e1319d/index.md) | completed |
