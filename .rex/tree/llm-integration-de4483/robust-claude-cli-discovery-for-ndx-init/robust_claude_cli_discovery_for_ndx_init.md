...
| Title | Status |
|-------|--------|
| [Emit actionable diagnostics when Claude CLI cannot be located](./emit-actionable-diagnostics-when-claude-cli-cannot-caadeb/index.md) | completed |
| [Implement multi-location Claude CLI discovery chain with configurable override](./implement-multi-location-claude-cli-discovery-chain-ac39fe/index.md) | completed |
