...
| Title | Status |
|-------|--------|
| [Add MacOS pipeline stage for ndx install-and-run smoke validation](./add-macos-pipeline-stage-for-ndx-d10a172b/index.md) | completed |
| [Add Windows pipeline stage for ndx install-and-run smoke validation](./add-windows-pipeline-stage-for-ndx-1a72b5c1/index.md) | completed |
| [Implement cross-platform parity assertions for deterministic CLI responses](./implement-cross-platform-parity-e1319df0/index.md) | completed |
