...
## Subtask: Gateway re-export-only and orchestration spawn-only static enforcement

**ID:** `f2e555ff-5cd7-47ae-a8f6-3b4d7adf8eb5`
**Status:** completed
**Priority:** critical
...
## Subtask: Web zone reclassification: misplaced viewer files and web-dashboard dissolution

**ID:** `824bbfb3-3d3f-48cd-bed0-6232e0ee69ff`
**Status:** completed
**Priority:** high
...
## Subtask: Create shared-types.ts and register-scheduler.ts neutral modules

**ID:** `063c1715-fcdb-4723-ba7f-6f9664a200f1`
**Status:** completed
**Priority:** high
...
## Subtask: Test coverage: landing.ts smoke test and task-usage.ts unit tests

**ID:** `eece6999-1355-4644-9bef-8c0740bb7ec0`
**Status:** completed
**Priority:** high
...
## Subtask: Cross-package integration test infrastructure and scheduler integration test

**ID:** `9fc27914-0c61-4963-8b29-b1aa90c9a1c3`
**Status:** completed
**Priority:** medium

Create tests/integration/ at monorepo root with cross-package contract tests. Add scheduler startup integration test. Addresses findings 4, 5.

---

## Subtask: Include llm-client in monorepo zone analysis

**ID:** `1db08695-80c1-43f0-93b4-42d0c0ce1223`
**Status:** completed
**Priority:** medium

Add monorepo-level zone-analysis pass that includes llm-client's internal zones so foundation-tier coupling is visible. Addresses finding 2.

---

## Subtask: Rex zone refactoring: 8 high-risk zones

**ID:** `42983eb6-08c9-4e6b-9c4e-6e8671f18c5a`
**Status:** completed
**Priority:** high
