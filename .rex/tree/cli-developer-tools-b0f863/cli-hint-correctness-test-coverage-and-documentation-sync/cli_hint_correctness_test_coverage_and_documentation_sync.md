...
| Title | Status |
|-------|--------|
| [Add regression tests that verify hint surfacing and follow-through correctness](./add-regression-tests-that-verify-hint-surfacing-and-2fc455/index.md) | completed |
| [Audit and repair CLI hint text across all commands](./audit-and-repair-cli-hint-text-across-all-commands/index.md) | completed |
| [Synchronize project documentation with current CLI command surface](./synchronize-project-documentation-with-current-cli-f2bfa3/index.md) | completed |
