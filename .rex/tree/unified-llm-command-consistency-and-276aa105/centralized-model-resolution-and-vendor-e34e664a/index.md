...
| Title | Status |
|-------|--------|
| [Add explicit resolveVendorModel and vendor/model header to reshape, reorganize, and prune commands](./add-explicit-resolvevendormodel-and-11e14b47/index.md) | completed |
| [Replace hardcoded model defaults in sourcevision analyze with centralized resolveVendorModel](./replace-hardcoded-model-defaults-in-15313bb7/index.md) | completed |
