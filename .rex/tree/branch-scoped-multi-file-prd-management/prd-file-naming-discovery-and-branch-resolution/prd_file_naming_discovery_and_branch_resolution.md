...
| Title | Status |
|-------|--------|
| [Implement branch-aware PRD file naming convention and git branch/commit resolution](./implement-branch-aware-prd-file-naming-convention-e7e014/index.md) | completed |
| [Implement PRD file discovery and selection logic within the .rex directory](./implement-prd-file-discovery-and-selection-logic-8be8d4/index.md) | completed |
