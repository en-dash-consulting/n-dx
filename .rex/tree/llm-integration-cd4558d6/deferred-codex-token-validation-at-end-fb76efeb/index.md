...
| Title | Status |
|-------|--------|
| [Audit Codex token validation and budget-check call sites within the hench work run loop](./audit-codex-token-validation-and-budget-4ac54c3d/index.md) | completed |
| [Refactor Codex token accumulation to defer validation and reporting until run completion](./refactor-codex-token-accumulation-to-70b824a2/index.md) | completed |
