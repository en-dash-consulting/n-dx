...
| Title | Status |
|-------|--------|
| [Add regression tests for ANSI color reset and line-boundary consistency](./add-regression-tests-for-ansi-color-reset-and-line-dbb2f5/index.md) | completed |
| [Audit and fix missing ANSI reset codes in tool and CLI output lines](./audit-and-fix-missing-ansi-reset-codes-in-tool-and-5f17b7/index.md) | completed |
