...
| Title | Status |
|-------|--------|
| [Detect and expose invocation context in hench runner](./detect-and-expose-invocation-context-in-hench-runner/index.md) | completed |
| [Display execution context indicator to users in CLI and dashboard](./display-execution-context-indicator-to-users-in-cli-eab929/index.md) | completed |
