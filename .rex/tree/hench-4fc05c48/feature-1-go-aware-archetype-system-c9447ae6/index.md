...
| Title | Status |
|-------|--------|
| [Implement language-scoped ArchetypeSignal schema and add Go signals to archetypes](./implement-language-scoped-7cbffe7e/index.md) | completed |
| [Write archetype classification tests for Go projects](./write-archetype-classification-tests-4cba126c/index.md) | completed |
