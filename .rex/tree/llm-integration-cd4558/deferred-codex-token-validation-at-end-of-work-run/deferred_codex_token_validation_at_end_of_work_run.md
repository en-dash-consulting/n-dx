...
| Title | Status |
|-------|--------|
| [Audit Codex token validation and budget-check call sites within the hench work run loop](./audit-codex-token-validation-and-budget-check-call-4ac54c/index.md) | completed |
| [Refactor Codex token accumulation to defer validation and reporting until run completion](./refactor-codex-token-accumulation-to-defer-70b824/index.md) | completed |
