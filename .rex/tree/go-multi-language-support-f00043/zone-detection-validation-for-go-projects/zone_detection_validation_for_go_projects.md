...
| Title | Status |
|-------|--------|
| [Document Go zone detection behavior, edge semantics, and known limitations](./document-go-zone-detection-behavior-edge-semantics-81da16/index.md) | completed |
| [Write end-to-end zone detection integration test for the Go fixture](./write-end-to-end-zone-detection-integration-test-f2234f/index.md) | completed |
