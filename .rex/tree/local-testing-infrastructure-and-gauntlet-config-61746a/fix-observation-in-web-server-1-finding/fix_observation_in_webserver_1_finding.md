...
| Title | Status |
|-------|--------|
| [Fix observation in web-server: Low cohesion (0.33) — files are loosely related, consider splitting this zone](./fix-observation-in-web-server-low-cohesion-0-33-19f2f8/index.md) | completed |
