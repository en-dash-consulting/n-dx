...
| Title | Status |
|-------|--------|
| [Audit all read and write call sites that still reference prd.md as primary storage](./audit-all-read-and-write-call-sites-that-still-6fa121/index.md) | completed |
| [Remove prd.md read fallback from PRDStore and all CLI, MCP, and web consumers](./remove-prd-md-read-fallback-from-prdstore-and-all-1e7c95/index.md) | completed |
