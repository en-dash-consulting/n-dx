...
| Title | Status |
|-------|--------|
| [Implement rolling 10-line grey output window for rex run console](./implement-rolling-10-line-grey-output-window-for-b86e2a/index.md) | completed |
| [Persist full rex run log to .run-logs/ and add directory to .gitignore](./persist-full-rex-run-log-to-run-logs-and-add-b892e5/index.md) | completed |
