...
| Title | Status |
|-------|--------|
| [Intercept SIGINT during hench run loop and transition to graceful cancellation state](./intercept-sigint-during-hench-run-loop-and-f00023/index.md) | completed |
| [Show rollback prompt on Ctrl+C cancellation and reset PRD task status](./show-rollback-prompt-on-ctrl-c-cancellation-and-6dc861/index.md) | completed |
