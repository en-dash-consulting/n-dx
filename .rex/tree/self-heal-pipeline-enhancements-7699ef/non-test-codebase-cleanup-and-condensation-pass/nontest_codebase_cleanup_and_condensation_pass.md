...
| Title | Status |
|-------|--------|
| [Apply production-scoped cleanup transformations with test-exclusion hard guard](./apply-production-scoped-cleanup-transformations-dd4783/index.md) | completed |
| [Implement scoped dead-code and duplication analyzer for production files](./implement-scoped-dead-code-and-duplication-analyzer-be4d8d/index.md) | completed |
