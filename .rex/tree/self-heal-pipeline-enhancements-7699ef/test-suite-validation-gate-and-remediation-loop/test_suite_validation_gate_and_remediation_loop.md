...
| Title | Status |
|-------|--------|
| [Implement test-failure remediation sub-loop in self-heal](./implement-test-failure-remediation-sub-loop-in-self-heal/index.md) | completed |
| [Integrate full test suite runner as a mandatory self-heal gate step](./integrate-full-test-suite-runner-as-a-mandatory-c18166/index.md) | completed |
