...
| [Interactive init banner and provider selection](./interactive-init-banner-and-provider-selection/index.md) | completed |
| [Provider authentication preflight during init](./provider-authentication-preflight-during-init/index.md) | completed |
