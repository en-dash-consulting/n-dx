...
| Title | Status |
|-------|--------|
| [Audit and surface all package commands through ndx](./audit-and-surface-all-package-commands-through-ndx/index.md) | completed |
| [Helpful error when users run package commands that belong to ndx](./helpful-error-when-users-run-package-commands-that-926c6d/index.md) | completed |
