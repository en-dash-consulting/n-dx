...
| Title | Status |
|-------|--------|
| [Audit all ndx CLI commands against web dashboard feature coverage and document gaps](./audit-all-ndx-cli-commands-against-web-dashboard-400f7e/index.md) | completed |
| [Implement dashboard trigger controls for CLI commands lacking UI representation](./implement-dashboard-trigger-controls-for-cli-5320dc/index.md) | completed |
