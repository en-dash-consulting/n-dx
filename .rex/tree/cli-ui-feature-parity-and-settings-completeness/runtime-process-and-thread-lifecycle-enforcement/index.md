...
| Title | Status |
|-------|--------|
| [Audit and enforce worker thread cleanup across all CLI entry points](./audit-and-enforce-worker-thread-cleanup-across-all-b1dc58/index.md) | completed |
| [Implement orphan process detection and cleanup for spawned subcommands](./implement-orphan-process-detection-and-cleanup-for-4e870c/index.md) | completed |
