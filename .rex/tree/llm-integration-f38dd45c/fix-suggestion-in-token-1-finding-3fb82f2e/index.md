...
| Title | Status |
|-------|--------|
| [Fix suggestion in token: Zone "Token" (token) has critical risk (score: 0.65, cohesion: 0.35, coupling: 0](./fix-suggestion-in-token-zone-token-db8cf9f9/index.md) | completed |
