...
| Title | Status |
|-------|--------|
| [Filter hench task selection to self-heal tagged items when running in self-heal mode](./filter-hench-task-selection-to-self-4fc2aacd/index.md) | completed |
| [Implement self-heal loop auto-termination when all self-heal items are completed](./implement-self-heal-loop-auto-ed9b7154/index.md) | completed |
