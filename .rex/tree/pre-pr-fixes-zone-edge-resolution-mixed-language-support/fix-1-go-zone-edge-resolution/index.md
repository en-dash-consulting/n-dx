...
| Title | Status |
|-------|--------|
| [Add test coverage for Go zone edge resolution](./add-test-coverage-for-go-zone-edge-resolution/index.md) | completed |
| [Implement Go directory-to-files resolver and update zone pipeline](./implement-go-directory-to-files-resolver-and-update-9c2806/index.md) | completed |
