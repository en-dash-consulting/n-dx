...
| Title | Status |
|-------|--------|
| [Add test coverage for mixed-language detection](./add-test-coverage-for-mixed-language-detection/index.md) | completed |
| [Implement multi-language detection and extend Manifest schema](./implement-multi-language-detection-and-extend-d56717/index.md) | completed |
