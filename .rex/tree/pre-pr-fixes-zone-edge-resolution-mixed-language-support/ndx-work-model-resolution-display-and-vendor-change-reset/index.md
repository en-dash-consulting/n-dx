...
| Title | Status |
|-------|--------|
| [Fix observation in global: Bidirectional coupling: "web" ↔ "web-server" (85+5 crossings) — consider extract](./fix-observation-in-global-bidirectional-coupling-de5ca6/index.md) | completed |
| [Implement vendor-change model reset to prevent cross-vendor stale config](./implement-vendor-change-model-reset-to-prevent-cc8616/index.md) | completed |
