...
| Title | Status |
|-------|--------|
| [Design and document the markdown schema for full-fidelity PRD tree representation](./design-and-document-the-markdown-schema-52811e0d/index.md) | completed |
| [Implement bidirectional markdown serializer and parser with round-trip fidelity tests](./implement-bidirectional-markdown-35ccf9ee/index.md) | completed |
