...
| Title | Status |
|-------|--------|
| [Add integration tests for Ctrl-C interrupt and rollback prompt interaction](./add-integration-tests-for-ctrl-c-interrupt-and-20bbb6/index.md) | completed |
| [Suspend custom SIGINT handler during rollback confirmation prompt](./suspend-custom-sigint-handler-during-rollback-5cfeee/index.md) | completed |
