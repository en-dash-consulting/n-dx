...
| Title | Status |
|-------|--------|
| [Fix code in sourcevision-view-tests: Coupling score 0.75 is produced entirely by false-positive string-literal edges,](./fix-code-in-sourcevision-view-tests-coupling-score-b180b9/index.md) | completed |
