...
- **Surfaces** — 36
- **Per-call total** — 21,872 tokens (what every surface costs, summed)
- **Unique fixed text** — 13,385 tokens (distinct text a rewrite has to edit)
...
## hench — 3,715 per-call / 3,715 unique, 9 surfaces
