...
describe("groupByCommand", () => {
  it("groups events by package:command", () => {
    const events: TokenEvent[] = [
      { timestamp: "2026-01-15T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 3000, outputTokens: 500, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 2 },
      { timestamp: "2026-01-16T10:00:00.000Z", command: "run", package: "hench", inputTokens: 5000, outputTokens: 1500, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-01-17T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 2000, outputTokens: 300, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
    ];
  ...
  it("sorts by total tokens descending", () => {
    const events: TokenEvent[] = [
      { timestamp: "2026-01-15T10:00:00.000Z", command: "analyze", package: "sv", inputTokens: 100, outputTokens: 50, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-01-16T10:00:00.000Z", command: "run", package: "hench", inputTokens: 50000, outputTokens: 10000, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 5 },
      { timestamp: "2026-01-17T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 500, outputTokens: 200, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 2 },
    ];
...
describe("groupByTimePeriod", () => {
  it("groups events by day", () => {
    const events: TokenEvent[] = [
      { timestamp: "2026-01-15T08:00:00.000Z", command: "analyze", package: "rex", inputTokens: 1000, outputTokens: 200, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-01-15T14:00:00.000Z", command: "run", package: "hench", inputTokens: 3000, outputTokens: 500, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-01-16T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 2000, outputTokens: 400, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
    ];
  ...
  it("groups events by month", () => {
    const events: TokenEvent[] = [
      { timestamp: "2026-01-15T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 1000, outputTokens: 200, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-02-10T10:00:00.000Z", command: "run", package: "hench", inputTokens: 5000, outputTokens: 1000, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-02-20T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 2000, outputTokens: 400, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
    ];
  ...
  it("groups events by week", () => {
    const events: TokenEvent[] = [
      { timestamp: "2026-01-12T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 1000, outputTokens: 200, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-01-14T10:00:00.000Z", command: "run", package: "hench", inputTokens: 3000, outputTokens: 500, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-01-20T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 2000, outputTokens: 400, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
    ];
  ...
  it("sorts buckets by period ascending", () => {
    const events: TokenEvent[] = [
      { timestamp: "2026-03-01T10:00:00.000Z", command: "run", package: "hench", inputTokens: 3000, outputTokens: 500, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
      { timestamp: "2026-01-01T10:00:00.000Z", command: "analyze", package: "rex", inputTokens: 1000, outputTokens: 200, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
    ];
  ...
  it("includes cost estimation per bucket", () => {
    const events: TokenEvent[] = [
      { timestamp: "2026-01-15T10:00:00.000Z", command: "run", package: "hench", inputTokens: 1000000, outputTokens: 1000000, cacheCreationTokens: 0, cacheReadTokens: 0, calls: 1 },
    ];
