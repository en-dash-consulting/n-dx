...
Outgoing (this zone → other zones):
  → cli-mcp-interface: src/cli/commands/fix.ts → src/cli/commands/constants.ts; src/cli/commands/fix.ts → src/cli/output.ts
  → prd-analysis-core: src/core/fix.ts → src/schema/index.ts; tests/unit/cli/commands/fix.test.ts → src/schema/index.ts; tests/unit/core/fix.test.ts → src/schema/index.ts
  → prd-storage-adapters: src/cli/commands/fix.ts → src/store/index.ts
  → prd-tree-lifecycle: src/core/fix.ts → src/core/tree.ts

Incoming (other zones → this zone):
  ← cli-mcp-interface: src/cli/index.ts → src/cli/commands/fix.ts
