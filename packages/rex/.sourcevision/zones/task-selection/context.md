...
Outgoing (this zone → other zones):
  → cli-mcp-interface: src/cli/commands/next.ts → src/cli/commands/constants.ts; src/cli/commands/next.ts → src/cli/output.ts
  → prd-analysis-core: src/core/next-task.ts → src/schema/index.ts; src/core/next-task.ts → src/schema/index.ts; tests/unit/core/feature-filtered-task.test.ts → src/schema/index.ts; tests/unit/core/next-task-matching.test.ts → src/schema/index.ts; tests/unit/core/next-task-scoring.test.ts → src/schema/index.ts; tests/unit/core/next-task.test.ts → src/schema/index.ts; tests/unit/core/requirements-prioritization.test.ts → src/schema/index.ts
  → prd-storage-adapters: src/cli/commands/next.ts → src/store/index.ts
  → prd-tree-lifecycle: src/core/next-task.ts → src/core/keywords.ts; src/core/next-task.ts → src/core/requirements.ts; src/core/next-task.ts → src/core/tree.ts; src/core/next-task.ts → src/core/tree.ts

Incoming (other zones → this zone):
  ← cli-mcp-interface: src/cli/index.ts → src/cli/commands/next.ts; src/cli/mcp-tools.ts → src/core/next-task.ts
  ← prd-tree-lifecycle: src/public.ts → src/core/next-task.ts; src/public.ts → src/core/next-task.ts
