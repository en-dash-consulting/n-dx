...
const NUMERIC_PATHS = new Set(["llm.local.port", "llm.escalation.maxSteps"]);

/** Numeric paths validated as TCP ports rather than plain integers. */
const PORT_PATHS = new Set(["llm.local.port"]);
