  ...
  it("hench llm-gateway source exports match contract test list", () => {
    ...
    const testedSymbols = new Set([
      ...["loadClaudeConfig", "loadLLMConfig", "resolveApiKey", "resolveCliPath",
        ...
        "exec", "execStdout", "execShellCmd", "hasPosixShell", "resolveShellKind",
        "getCurrentHead", "getCurrentBranch",
        "getWorktreeRoot", "getGitCommonDir", "listWorktrees",
        ...
        "createProgressReporter", "setActiveProgressReporter", "getActiveProgressReporter"],
