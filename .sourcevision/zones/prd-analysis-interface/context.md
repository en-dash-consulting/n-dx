# PRD Analysis Interface — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: PRD Analysis Interface (`prd-analysis-interface`)
Files: 7, Cohesion: 0.67, Coupling: 0.33
Description: Provides UI components for analyzing projects and managing PRD proposals and batch imports.
...
Outgoing (this zone → other zones):
  → web-platform: packages/web/src/viewer/views/analysis.ts → packages/web/src/viewer/components/prd-tree/shared-imports.ts

Incoming (other zones → this zone):
  ← application-shell-components: packages/web/src/viewer/main.ts → packages/web/src/viewer/views/analysis.ts
  ← ui-foundation: packages/web/src/viewer/views/rex-dashboard.ts → packages/web/src/viewer/components/prd-tree/smart-add-input.ts
  ← web-platform: packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/analyze-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/analyze-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/batch-import-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/batch-import-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/proposal-editor.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/proposal-editor.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/smart-add-input.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/smart-add-input.ts

</imports>

<findings>

[suggestion] [info] Move analysis.ts [page] to dedicated page/view zone, keep only UI components in interface zone
