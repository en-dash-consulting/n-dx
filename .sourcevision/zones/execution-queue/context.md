# Execution Queue — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Execution Queue (`execution-queue`)
Files: 7, Cohesion: 0.88, Coupling: 0.13
Description: Task queue management system that handles scheduling and execution of agent operations.
...
Incoming (other zones → this zone):
  ← agent-core: packages/hench/src/cli/commands/run.ts → packages/hench/src/queue/index.ts; packages/hench/src/cli/commands/run.ts → packages/hench/src/queue/index.ts; packages/hench/src/public.ts → packages/hench/src/queue/index.ts; packages/hench/src/public.ts → packages/hench/src/queue/index.ts
...
[suggestion] [info] format.ts utility may be misplaced within queue-specific module if it provides general-purpose formatting capabilities
