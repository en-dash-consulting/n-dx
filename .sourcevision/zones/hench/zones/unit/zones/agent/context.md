...
Files: 90, Cohesion: 0.86, Coupling: 0.14
Description: 90 files, primarily TypeScript
Entry points: packages/hench/src/agent/analysis/summary.ts, packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/agent/planning/brief.ts, packages/hench/src/agent/planning/prompt.ts, packages/hench/src/cli/commands/run.ts, packages/hench/src/cli/errors.ts, packages/hench/src/cli/output.ts, packages/hench/src/prd/rex-gateway.ts, packages/hench/src/process/index.ts, packages/hench/src/process/memory-monitor.ts, packages/hench/src/schema/index.ts, packages/hench/src/schema/v1.ts, packages/hench/src/store/config.ts, packages/hench/src/tools/exec-shell.ts, packages/hench/src/tools/rex.ts
Lines: 25418
...
Cross-dependencies between sub-zones:
  hench/unit/agent/agent → hench/unit/agent/cli: 9
  hench/unit/agent/agent → hench/unit/agent/cli-commands: 4
  hench/unit/agent/agent → hench/unit/agent/process: 15
  ...
  hench/unit/agent/cli → hench/unit/agent/queue: 2
  hench/unit/agent/cli-commands → hench/unit/agent/agent: 3
  ...
  hench/unit/agent/process → hench/unit/agent/queue: 2
...
- **Hench/unit/agent/agent** (`hench/unit/agent/agent`): 17 files, cohesion 0.34, coupling 0.66
- **Hench/unit/agent/cli** (`hench/unit/agent/cli`): 9 files, cohesion 0.3, coupling 0.7
- **Hench/unit/agent/cli Commands** (`hench/unit/agent/cli-commands`): 22 files, cohesion 0.75, coupling 0.25
- **Hench/unit/agent/process** (`hench/unit/agent/process`): 35 files, cohesion 0.73, coupling 0.27
- **Hench/unit/agent/queue** (`hench/unit/agent/queue`): 7 files, cohesion 0.83, coupling 0.17
