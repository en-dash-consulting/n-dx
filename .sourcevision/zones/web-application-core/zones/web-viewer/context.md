...
Files: 217, Cohesion: 0.99, Coupling: 0.01
Description: 217 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/copy-link-button.ts, packages/web/src/viewer/components/elapsed-time.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/prd-tree/prd-tree.ts, packages/web/src/viewer/components/prd-tree/types.ts, packages/web/src/viewer/components/rex-task-link.ts, packages/web/src/viewer/components/sidebar.ts, packages/web/src/viewer/components/theme-toggle.ts, packages/web/src/viewer/components/throttle-controls.ts, packages/web/src/viewer/components/ws-health-panel.ts, packages/web/src/viewer/external.ts, packages/web/src/viewer/hooks/use-crash-recovery.ts, packages/web/src/viewer/hooks/use-polling.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts, packages/web/src/viewer/visualization/index.ts
Lines: 62178
...
Cross-dependencies between sub-zones:
  web-viewer/web-viewer/panel → web-viewer/web-viewer/status: 1
  web-viewer/web-viewer/panel → web-viewer/web-viewer/web: 6
  web-viewer/web-viewer/panel → web-viewer/web-viewer/web-2: 1
  web-viewer/web-viewer/prune → web-viewer/web-viewer/web-2: 5
  web-viewer/web-viewer/status → web-viewer/web-viewer/panel: 1
  web-viewer/web-viewer/status → web-viewer/web-viewer/web: 2
  web-viewer/web-viewer/use → web-viewer/web-viewer/prune: 1
  web-viewer/web-viewer/use → web-viewer/web-viewer/web: 2
  web-viewer/web-viewer/use → web-viewer/web-viewer/web-2: 13
  web-viewer/web-viewer/use → web-viewer/web-viewer/web-3: 2
  web-viewer/web-viewer/web → web-viewer/web-viewer/panel: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/status: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/use: 1
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-2: 2
  web-viewer/web-viewer/web → web-viewer/web-viewer/web-viewer: 3
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/panel: 1
  web-viewer/web-viewer/web-2 → web-viewer/web-viewer/web: 7
...
- **Web Viewer/web Viewer/status** (`web-viewer/web-viewer/status`): 3 files, cohesion 0.29, coupling 0.71
- **Web Viewer/web Viewer/use** (`web-viewer/web-viewer/use`): 6 files, cohesion 0.36, coupling 0.64
- **Web Viewer/web Viewer/web** (`web-viewer/web-viewer/web`): 138 files, cohesion 0.93, coupling 0.07
  - Has 8 nested sub-zone(s)
- **Web Viewer/web Viewer/web 2** (`web-viewer/web-viewer/web-2`): 55 files, cohesion 0.81, coupling 0.19
  - Has 7 nested sub-zone(s)
- **Web Viewer/web Viewer/web 3** (`web-viewer/web-viewer/web-3`): 3 files, cohesion 0.25, coupling 0.75
- **Web Viewer/web Viewer/web Viewer** (`web-viewer/web-viewer/web-viewer`): 4 files, cohesion 0.31, coupling 0.69
