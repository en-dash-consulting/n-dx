...
Files: 138, Cohesion: 0.93, Coupling: 0.07
Description: 138 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/copy-link-button.ts, packages/web/src/viewer/components/elapsed-time.ts, packages/web/src/viewer/components/faq.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/rex-task-link.ts, packages/web/src/viewer/components/theme-toggle.ts, packages/web/src/viewer/components/throttle-controls.ts, packages/web/src/viewer/components/ws-health-panel.ts, packages/web/src/viewer/external.ts, packages/web/src/viewer/hooks/use-crash-recovery.ts, packages/web/src/viewer/performance/index.ts, packages/web/src/viewer/polling/index.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts, packages/web/src/viewer/visualization/index.ts
Lines: 37448
...
Cross-dependencies between sub-zones:
  ...
  web-viewer/web-viewer/web/domain → web-viewer/web-viewer/web/viewer-2: 2
  web-viewer/web-viewer/web/domain → web-viewer/web-viewer/web/viewer-performance: 1
  web-viewer/web-viewer/web/domain → web-viewer/web-viewer/web/viewer-views: 6
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/domain: 1
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/viewer: 2
  ...
  web-viewer/web-viewer/web/integration → web-viewer/web-viewer/web/viewer-performance: 6
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/viewer-views: 7
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer: 8
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer-components: 2
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer-performance: 5
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer-views: 2
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer: 1
  web-viewer/web-viewer/web/viewer-hooks → web-viewer/web-viewer/web/viewer: 6
  ...
  web-viewer/web-viewer/web/viewer-performance → web-viewer/web-viewer/web/viewer-2: 2
...
- **Web Viewer/web Viewer/web/domain** (`web-viewer/web-viewer/web/domain`): 5 files, cohesion 0.31, coupling 0.69
- **Web Viewer/web Viewer/web/integration** (`web-viewer/web-viewer/web/integration`): 3 files, cohesion 1, coupling 0
- **Web Viewer/web Viewer/web/viewer** (`web-viewer/web-viewer/web/viewer`): 42 files, cohesion 0.81, coupling 0.19
- **Web Viewer/web Viewer/web/viewer 2** (`web-viewer/web-viewer/web/viewer-2`): 19 files, cohesion 0.57, coupling 0.43
- **Web Viewer/web Viewer/web/viewer Components** (`web-viewer/web-viewer/web/viewer-components`): 3 files, cohesion 0.4, coupling 0.6
- **Web Viewer/web Viewer/web/viewer Hooks** (`web-viewer/web-viewer/web/viewer-hooks`): 5 files, cohesion 0.43, coupling 0.57
- **Web Viewer/web Viewer/web/viewer Performance** (`web-viewer/web-viewer/web/viewer-performance`): 53 files, cohesion 0.84, coupling 0.16
- **Web Viewer/web Viewer/web/viewer Views** (`web-viewer/web-viewer/web/viewer-views`): 8 files, cohesion 0.43, coupling 0.57
