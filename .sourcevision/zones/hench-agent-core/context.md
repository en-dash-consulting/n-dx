...
Zone: Hench Agent Core (`hench-agent-core`)
Files: 94, Cohesion: 0.95, Coupling: 0.05
Description: Execution engine that assembles briefs, runs the agent loop, validates output, and summarizes autonomous work.
...
packages/hench/src/agent/lifecycle/cli-loop.ts (TypeScript, 520 lines, source)
packages/hench/src/agent/lifecycle/heartbeat.ts (TypeScript, 71 lines, source)
packages/hench/src/agent/lifecycle/loop.ts (TypeScript, 309 lines, source)
...
Outgoing (this zone → other zones):
  → hench-guard-and-tools: packages/hench/src/agent/lifecycle/loop.ts → packages/hench/src/guard/index.ts; packages/hench/src/agent/lifecycle/loop.ts → packages/hench/src/tools/dispatch.ts; packages/hench/src/tools/index.ts → packages/hench/src/tools/dispatch.ts; packages/hench/src/tools/index.ts → packages/hench/src/tools/files.ts; packages/hench/src/tools/index.ts → packages/hench/src/tools/git.ts; packages/hench/src/tools/index.ts → packages/hench/src/tools/shell.ts; packages/hench/src/types/index.ts → packages/hench/src/guard/index.ts; packages/hench/tests/unit/agent/task-failure.test.ts → packages/hench/src/agent/tools.ts

Incoming (other zones → this zone):
  ← hench-guard-and-tools: packages/hench/src/agent/tools.ts → packages/hench/src/types/index.ts; packages/hench/src/guard/index.ts → packages/hench/src/schema/index.ts; packages/hench/src/tools/dispatch.ts → packages/hench/src/tools/rex.ts; packages/hench/src/tools/dispatch.ts → packages/hench/src/types/index.ts; packages/hench/src/tools/git.ts → packages/hench/src/process/exec-shell.ts; packages/hench/src/tools/shell.ts → packages/hench/src/process/exec-shell.ts; packages/hench/tests/unit/guard/guard-integration.test.ts → packages/hench/src/schema/v1.ts; packages/hench/tests/unit/tools/files.test.ts → packages/hench/src/schema/v1.ts; packages/hench/tests/unit/tools/git.test.ts → packages/hench/src/schema/v1.ts; packages/hench/tests/unit/tools/shell.test.ts → packages/hench/src/schema/v1.ts
...
[observation] [info] Stuck-task heuristics in `packages/hench/src/agent/analysis/stuck.ts:1` depend on callers to pass a threshold, so document or set a default in the run orchestration to keep failure detection consistent across commands.
[observation] [info] The review gate in `packages/hench/src/agent/analysis/review.ts:1` hardcodes a 30s prompt timeout; expose that through config or CLI flags before enabling unattended review flows, otherwise approvals can block runs.
[observation] [info] Use `packages/hench/src/agent/index.ts:1` as the lone import surface for lifecycle, planning, and analysis primitives so CLI layers don’t deep-import internals and accidentally create cycles.
...
- Re-exports lifecycle/planning/analysis APIs so upstream callers have a single surface.
- Owns human-in-the-loop checkpoints like review gates and stuck-task detection.
- Use `packages/hench/src/agent/index.ts:1` as the lone import surface for lifecycle, planning, and analysis primitives so CLI layers don’t deep-import internals and accidentally create cycles.
- The review gate in `packages/hench/src/agent/analysis/review.ts:1` hardcodes a 30s prompt timeout; expose that through config or CLI flags before enabling unattended review flows, otherwise approvals can block runs.
- Stuck-task heuristics in `packages/hench/src/agent/analysis/stuck.ts:1` depend on callers to pass a threshold, so document or set a default in the run orchestration to keep failure detection consistent across commands.
- [call graph] 1824 internal calls, 2 outgoing, 27 incoming (cohesion: 1, coupling: 0)
...
- **Tests** (`hench/tests`): 47 files, cohesion 0.83, coupling 0.17
- **Tests 2** (`hench/tests-2`): 9 files, cohesion 0.67, coupling 0.33
- **Tests 3** (`hench/tests-3`): 24 files, cohesion 0.7, coupling 0.3
