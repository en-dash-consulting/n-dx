# Web Platform — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Web Platform (`web-platform`)
Files: 137, Cohesion: 0.87, Coupling: 0.13
Description: Dashboard and MCP server platform that provides HTTP interfaces and visual management for the entire n-dx system.
...
Outgoing (this zone → other zones):
  → dashboard-visualization: packages/web/src/viewer/views/hench-runs.ts → packages/web/src/viewer/components/data-display/health-gauge.ts
  → graceful-degradation-system: packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/execution-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/execution-panel.ts
  → message-flow-control: packages/web/src/viewer/views/prd.ts → packages/web/src/viewer/call-rate-limiter.ts; packages/web/src/viewer/views/prd.ts → packages/web/src/viewer/message-coalescer.ts; packages/web/src/viewer/views/prd.ts → packages/web/src/viewer/message-throttle.ts
  ...
  → performance-optimization-layer: packages/web/src/viewer/views/prd.ts → packages/web/src/viewer/dom-update-gate.ts; packages/web/src/viewer/views/prd.ts → packages/web/src/viewer/response-buffer-gate.ts; packages/web/src/viewer/views/prd.ts → packages/web/src/viewer/update-batcher.ts
  → polling-infrastructure: packages/web/src/viewer/views/hench-runs.ts → packages/web/src/viewer/hooks/use-polling.ts; packages/web/src/viewer/views/prd.ts → packages/web/src/viewer/hooks/use-polling.ts
  → prd-analysis-interface: packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/analyze-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/analyze-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/batch-import-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/batch-import-panel.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/proposal-editor.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/proposal-editor.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/smart-add-input.ts; packages/web/src/viewer/components/prd-tree/index.ts → packages/web/src/viewer/components/prd-tree/smart-add-input.ts
  → request-deduplication-system: packages/web/src/viewer/views/prd.ts → packages/web/src/viewer/request-dedup.ts
  → time-tracking-interface: packages/web/src/viewer/components/active-tasks-panel.ts → packages/web/src/viewer/components/elapsed-time.ts
  → ui-foundation: packages/web/src/viewer/components/active-tasks-panel.ts → packages/web/src/viewer/types.ts; packages/web/src/viewer/components/prd-tree/shared-imports.ts → packages/web/src/viewer/types.ts; packages/web/src/viewer/components/rex-task-link.ts → packages/web/src/viewer/types.ts; packages/web/src/viewer/views/hench-runs.ts → packages/web/src/viewer/types.ts; packages/web/src/viewer/views/validation.ts → packages/web/src/viewer/types.ts
  → usage-analytics: packages/web/src/server/routes-hench.ts → packages/web/src/server/incremental-task-usage.ts; packages/web/src/server/start.ts → packages/web/src/server/usage-cleanup-scheduler.ts
...
Incoming (other zones → this zone):
  ← application-shell-components: packages/web/src/viewer/main.ts → packages/web/src/schema/data-files.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/components/guide.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/components/theme-toggle.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/feature-toggles.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/hench-config.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/hench-runs.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/hench-templates.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/integration-config.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/notion-config.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/pr-markdown.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/prd.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/validation.ts; packages/web/src/viewer/main.ts → packages/web/src/viewer/views/workflow-optimization.ts
  ← chart-visualization-layer: packages/web/src/viewer/views/problems.ts → packages/web/src/viewer/components/logos.ts
  ← dashboard-visualization: packages/web/src/viewer/views/overview.ts → packages/web/src/viewer/components/logos.ts
  ← data-visualization: packages/web/src/viewer/views/suggestions.ts → packages/web/src/viewer/components/logos.ts
  ← hierarchical-navigation: packages/web/src/viewer/views/routes.ts → packages/web/src/viewer/components/logos.ts
  ← interactive-data-visualization: packages/web/src/viewer/views/files.ts → packages/web/src/viewer/components/logos.ts; packages/web/src/viewer/views/graph.ts → packages/web/src/viewer/components/logos.ts; packages/web/src/viewer/views/zones.ts → packages/web/src/viewer/components/logos.ts
  ← polling-infrastructure: packages/web/src/viewer/views/token-usage.ts → packages/web/src/viewer/components/logos.ts
  ← prd-analysis-interface: packages/web/src/viewer/views/analysis.ts → packages/web/src/viewer/components/prd-tree/shared-imports.ts
  ← project-status-ui: packages/web/src/viewer/components/sidebar.ts → packages/web/src/viewer/components/logos.ts; packages/web/src/viewer/components/sidebar.ts → packages/web/src/viewer/components/theme-toggle.ts
  ← schema-infrastructure: packages/web/src/viewer/loader.ts → packages/web/src/schema/data-files.ts; packages/web/tests/unit/server/memory-leak-fixes.test.ts → packages/web/src/server/routes-mcp.ts
  ← time-tracking-interface: packages/web/src/viewer/views/task-audit.ts → packages/web/src/viewer/components/logos.ts; packages/web/src/viewer/views/task-audit.ts → packages/web/src/viewer/components/rex-task-link.ts
  ← ui-foundation: packages/web/src/viewer/views/architecture.ts → packages/web/src/viewer/components/logos.ts; packages/web/src/viewer/views/rex-dashboard.ts → packages/web/src/viewer/components/logos.ts; packages/web/src/viewer/views/rex-dashboard.ts → packages/web/src/viewer/components/rex-task-link.ts
  ← usage-analytics: packages/web/src/server/usage-cleanup-scheduler.ts → packages/web/src/server/rex-gateway.ts; packages/web/src/server/usage-cleanup-scheduler.ts → packages/web/src/server/rex-gateway.ts
...
[suggestion] [warning] Gateway pattern success in web-platform should be considered for agent-core's external dependencies to improve architectural consistency
