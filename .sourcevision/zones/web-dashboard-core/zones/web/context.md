...
Files: 272, Cohesion: 0.97, Coupling: 0.03
Description: 272 files, primarily TypeScript
Entry points: packages/web/src/server/rex-gateway.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/prd-tree/levels.ts, packages/web/src/viewer/components/sidebar.ts, packages/web/src/viewer/hooks/use-polling.ts, packages/web/src/viewer/performance/index.ts, packages/web/src/viewer/polling/index.ts, packages/web/src/viewer/polling/polling-state.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/visualization/index.ts
Lines: 85417
...
Cross-dependencies between sub-zones:
  web-viewer/web/polling → web-viewer/web/use: 2
  web-viewer/web/unit → web-viewer/web/unit-viewer: 2
  web-viewer/web/unit → web-viewer/web/viewer: 1
  web-viewer/web/use → web-viewer/web/polling: 6
  web-viewer/web/use → web-viewer/web/viewer: 1
  web-viewer/web/use → web-viewer/web/viewer-components: 4
  web-viewer/web/viewer → web-viewer/web/polling: 1
  web-viewer/web/viewer → web-viewer/web/unit: 4
  web-viewer/web/viewer → web-viewer/web/use: 4
  web-viewer/web/viewer → web-viewer/web/viewer-2: 4
  web-viewer/web/viewer → web-viewer/web/viewer-components: 9
  web-viewer/web/viewer-2 → web-viewer/web/polling: 1
  web-viewer/web/viewer-2 → web-viewer/web/unit-viewer: 1
  web-viewer/web/viewer-2 → web-viewer/web/use: 1
  web-viewer/web/viewer-2 → web-viewer/web/viewer: 5
  web-viewer/web/viewer-2 → web-viewer/web/viewer-components: 1
  web-viewer/web/viewer-components → web-viewer/web/unit-viewer: 3
  web-viewer/web/viewer-components → web-viewer/web/use: 9
  web-viewer/web/viewer-components → web-viewer/web/viewer: 1
  web-viewer/web/viewer-components → web-viewer/web/viewer-2: 5
...
- **Web Viewer/web/polling** (`web-viewer/web/polling`): 10 files, cohesion 0.63, coupling 0.38
- **Web Viewer/web/unit** (`web-viewer/web/unit`): 71 files, cohesion 0.97, coupling 0.03
  - Has 4 nested sub-zone(s)
- **Web Viewer/web/unit Viewer** (`web-viewer/web/unit-viewer`): 16 files, cohesion 0.88, coupling 0.13
- **Web Viewer/web/use** (`web-viewer/web/use`): 26 files, cohesion 0.75, coupling 0.25
- **Web Viewer/web/viewer** (`web-viewer/web/viewer`): 80 files, cohesion 0.92, coupling 0.08
  - Has 4 nested sub-zone(s)
- **Web Viewer/web/viewer 2** (`web-viewer/web/viewer-2`): 51 files, cohesion 0.92, coupling 0.08
  - Has 4 nested sub-zone(s)
- **Web Viewer/web/viewer Components** (`web-viewer/web/viewer-components`): 18 files, cohesion 0.55, coupling 0.45
