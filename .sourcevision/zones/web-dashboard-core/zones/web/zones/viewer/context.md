...
Files: 80, Cohesion: 0.92, Coupling: 0.08
Description: 80 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/sidebar.ts, packages/web/src/viewer/components/theme-toggle.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/visualization/index.ts
Lines: 21279
...
Cross-dependencies between sub-zones:
  web-viewer/web/viewer/components → web-viewer/web/viewer/views: 9
  web-viewer/web/viewer/components-2 → web-viewer/web/viewer/components: 6
  ...
  web-viewer/web/viewer/domain → web-viewer/web/viewer/components: 8
  web-viewer/web/viewer/domain → web-viewer/web/viewer/views: 10
  web-viewer/web/viewer/views → web-viewer/web/viewer/components: 10
  web-viewer/web/viewer/views → web-viewer/web/viewer/components-2: 1
...
- **Web Viewer/web/viewer/components** (`web-viewer/web/viewer/components`): 48 files, cohesion 0.84, coupling 0.16
- **Web Viewer/web/viewer/components 2** (`web-viewer/web/viewer/components-2`): 8 files, cohesion 0.53, coupling 0.47
- **Web Viewer/web/viewer/domain** (`web-viewer/web/viewer/domain`): 5 files, cohesion 0.3, coupling 0.7
- **Web Viewer/web/viewer/views** (`web-viewer/web/viewer/views`): 19 files, cohesion 0.55, coupling 0.45
