...
Files: 71, Cohesion: 0.97, Coupling: 0.03
...
- **Web Viewer/web/unit/server** (`web-viewer/web/unit/server`): 60 files, cohesion 0.94, coupling 0.06
- **Web Viewer/web/unit/server 2** (`web-viewer/web/unit/server-2`): 5 files, cohesion 0.71, coupling 0.29
- **Web Viewer/web/unit/server 3** (`web-viewer/web/unit/server-3`): 3 files, cohesion 0.4, coupling 0.6
