...
Description: Top-level entry points and configuration that coordinate between domain packages without importing their internals.
Lines: 4472
...
[suggestion] [info] Multiple refresh-* scripts suggest manual operations that could be consolidated into a single parameterized refresh command
