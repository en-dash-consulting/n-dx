...
Files: 77, Cohesion: 0.99, Coupling: 0.01
Description: 77 files, primarily TypeScript
Entry points: packages/web/src/server/prd-io.ts, packages/web/src/server/rex-gateway.ts, packages/web/src/server/types.ts, packages/web/src/viewer/views/pr-markdown.ts
Lines: 28635
...
Cross-dependencies between sub-zones:
  ...
  web-viewer/web/server/unit → web-viewer/web/server/unit-4: 11
...
- **Web Viewer/web/server/unit** (`web-viewer/web/server/unit`): 60 files, cohesion 0.92, coupling 0.08
- **Web Viewer/web/server/unit 2** (`web-viewer/web/server/unit-2`): 5 files, cohesion 0.5, coupling 0.5
- **Web Viewer/web/server/unit 3** (`web-viewer/web/server/unit-3`): 5 files, cohesion 0.5, coupling 0.5
- **Web Viewer/web/server/unit 4** (`web-viewer/web/server/unit-4`): 4 files, cohesion 1, coupling 0
