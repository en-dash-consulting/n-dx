...
Cross-dependencies between sub-zones:
  ...
  web-viewer/web/viewer-views → web-viewer/web/viewer: 31
...
- **Web Viewer/web/server** (`web-viewer/web/server`): 77 files, cohesion 0.99, coupling 0.01
...
- **Web Viewer/web/viewer Views** (`web-viewer/web/viewer-views`): 70 files, cohesion 0.81, coupling 0.19
  - Has 3 nested sub-zone(s)
