...
Entry points: packages/hench/src/agent/lifecycle/cli-loop.ts, packages/hench/src/agent/lifecycle/loop.ts, packages/hench/src/agent/planning/brief.ts, packages/hench/src/cli/commands/config.ts, packages/hench/src/cli/commands/init.ts, packages/hench/src/cli/commands/run.ts, packages/hench/src/cli/output.ts, packages/hench/src/prd/rex-gateway.ts, packages/hench/src/process/index.ts, packages/hench/src/process/memory-monitor.ts, packages/hench/src/schema/index.ts, packages/hench/src/schema/v1.ts, packages/hench/src/store/index.ts, packages/hench/src/store/project-config.ts, packages/hench/src/tools/exec-shell.ts, packages/hench/src/tools/rex.ts
Lines: 24225
...
Cross-dependencies between sub-zones:
  hench-unit/hench/agent → hench-unit/hench/unit: 8
  hench-unit/hench/agent-lifecycle → hench-unit/hench/agent: 2
  hench-unit/hench/agent-lifecycle → hench-unit/hench/unit: 4
  hench-unit/hench/agent-lifecycle → hench-unit/hench/unit-2: 2
  hench-unit/hench/agent-lifecycle → hench-unit/hench/unit-agent: 2
  hench-unit/hench/agent-lifecycle → hench-unit/hench/unit-cli: 2
  hench-unit/hench/unit → hench-unit/hench/agent: 2
  hench-unit/hench/unit → hench-unit/hench/store: 7
  hench-unit/hench/unit → hench-unit/hench/unit-2: 1
  hench-unit/hench/unit → hench-unit/hench/unit-agent: 1
  hench-unit/hench/unit-2 → hench-unit/hench/agent: 1
  hench-unit/hench/unit-2 → hench-unit/hench/agent-lifecycle: 1
  hench-unit/hench/unit-2 → hench-unit/hench/store: 1
  hench-unit/hench/unit-2 → hench-unit/hench/unit: 3
  hench-unit/hench/unit-2 → hench-unit/hench/unit-agent: 4
  hench-unit/hench/unit-2 → hench-unit/hench/unit-cli: 2
  hench-unit/hench/unit-agent → hench-unit/hench/agent: 2
  hench-unit/hench/unit-agent → hench-unit/hench/agent-lifecycle: 1
  hench-unit/hench/unit-agent → hench-unit/hench/store: 3
  hench-unit/hench/unit-agent → hench-unit/hench/unit: 10
  hench-unit/hench/unit-agent → hench-unit/hench/unit-2: 3
  hench-unit/hench/unit-agent → hench-unit/hench/unit-cli: 6
  hench-unit/hench/unit-cli → hench-unit/hench/agent: 1
  hench-unit/hench/unit-cli → hench-unit/hench/store: 2
  hench-unit/hench/unit-cli → hench-unit/hench/unit: 5
  hench-unit/hench/unit-cli → hench-unit/hench/unit-2: 2
  hench-unit/hench/unit-cli → hench-unit/hench/unit-agent: 1
...
- **Hench Unit/hench/agent** (`hench-unit/hench/agent`): 11 files, cohesion 0.48, coupling 0.52
- **Hench Unit/hench/agent Lifecycle** (`hench-unit/hench/agent-lifecycle`): 4 files, cohesion 0.18, coupling 0.82
- **Hench Unit/hench/store** (`hench-unit/hench/store`): 10 files, cohesion 0.57, coupling 0.43
- **Hench Unit/hench/unit** (`hench-unit/hench/unit`): 33 files, cohesion 0.67, coupling 0.33
- **Hench Unit/hench/unit 2** (`hench-unit/hench/unit-2`): 4 files, cohesion 0.12, coupling 0.88
- **Hench Unit/hench/unit Agent** (`hench-unit/hench/unit-agent`): 8 files, cohesion 0.2, coupling 0.8
- **Hench Unit/hench/unit Cli** (`hench-unit/hench/unit-cli`): 9 files, cohesion 0.31, coupling 0.69
