...
Files: 120, Cohesion: 0.94, Coupling: 0.06
...
- **Hench/unit/agent** (`hench/unit/agent`): 82 files, cohesion 0.86, coupling 0.14
  - Has 4 nested sub-zone(s)
- **Hench/unit/agent 2** (`hench/unit/agent-2`): 6 files, cohesion 0.31, coupling 0.69
- **Hench/unit/agent Analysis** (`hench/unit/agent-analysis`): 5 files, cohesion 0.35, coupling 0.65
...
- **Hench/unit/queue** (`hench/unit/queue`): 7 files, cohesion 0.88, coupling 0.13
