...
Cross-dependencies between sub-zones:
  web-viewer/web/viewer/components → web-viewer/web/viewer/components-prd-tree: 6
  web-viewer/web/viewer/components-prd-tree → web-viewer/web/viewer/components: 4
  web-viewer/web/viewer/components-prd-tree → web-viewer/web/viewer/prune: 1
  web-viewer/web/viewer/prune → web-viewer/web/viewer/components-prd-tree: 5
...
- **Web Viewer/web/viewer/components** (`web-viewer/web/viewer/components`): 17 files, cohesion 0.83, coupling 0.17
- **Web Viewer/web/viewer/components Prd Tree** (`web-viewer/web/viewer/components-prd-tree`): 60 files, cohesion 0.94, coupling 0.06
