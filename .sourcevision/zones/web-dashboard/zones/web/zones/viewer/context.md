...
Files: 86, Cohesion: 0.88, Coupling: 0.12
Description: 86 files, primarily TypeScript
Entry points: packages/web/src/schema/v1.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/sidebar.ts, packages/web/src/viewer/hooks/use-polling.ts, packages/web/src/viewer/polling/batched-tick-dispatcher.ts, packages/web/src/viewer/polling/index.ts, packages/web/src/viewer/polling/polling-restart.ts, packages/web/src/viewer/polling/polling-state.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts, packages/web/src/viewer/visualization/index.ts
Lines: 22064
...
Cross-dependencies between sub-zones:
  web-viewer/web/viewer/components → web-viewer/web/viewer/components-2: 1
  web-viewer/web/viewer/components → web-viewer/web/viewer/polling: 1
  web-viewer/web/viewer/components-2 → web-viewer/web/viewer/components: 8
  web-viewer/web/viewer/components-2 → web-viewer/web/viewer/polling: 1
  web-viewer/web/viewer/components-2 → web-viewer/web/viewer/views: 1
  web-viewer/web/viewer/hooks → web-viewer/web/viewer/components: 9
  web-viewer/web/viewer/views → web-viewer/web/viewer/components: 14
  web-viewer/web/viewer/views → web-viewer/web/viewer/hooks: 1
...
- **Web Viewer/web/viewer/components** (`web-viewer/web/viewer/components`): 54 files, cohesion 0.84, coupling 0.16
- **Web Viewer/web/viewer/components 2** (`web-viewer/web/viewer/components-2`): 10 files, cohesion 0.42, coupling 0.58
- **Web Viewer/web/viewer/hooks** (`web-viewer/web/viewer/hooks`): 8 files, cohesion 0.67, coupling 0.33
- **Web Viewer/web/viewer/polling** (`web-viewer/web/viewer/polling`): 9 files, cohesion 0.83, coupling 0.17
- **Web Viewer/web/viewer/views** (`web-viewer/web/viewer/views`): 5 files, cohesion 0.33, coupling 0.67
