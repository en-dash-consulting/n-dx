...
Files: 67, Cohesion: 0.80, Coupling: 0.20
Description: 67 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/sidebar.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/visualization/index.ts
Lines: 18086
...
Cross-dependencies between sub-zones:
  web-viewer/web/viewer-views/viewer → web-viewer/web/viewer-views/viewer-components: 1
  web-viewer/web/viewer-views/viewer → web-viewer/web/viewer-views/viewer-views: 1
  web-viewer/web/viewer-views/viewer-components → web-viewer/web/viewer-views/viewer: 8
  web-viewer/web/viewer-views/viewer-components → web-viewer/web/viewer-views/viewer-hooks: 1
  web-viewer/web/viewer-views/viewer-hooks → web-viewer/web/viewer-views/viewer: 3
  web-viewer/web/viewer-views/viewer-views → web-viewer/web/viewer-views/viewer: 3
...
- **Web Viewer/web/viewer Views/viewer** (`web-viewer/web/viewer-views/viewer`): 47 files, cohesion 0.9, coupling 0.1
- **Web Viewer/web/viewer Views/viewer Components** (`web-viewer/web/viewer-views/viewer-components`): 10 files, cohesion 0.44, coupling 0.56
- **Web Viewer/web/viewer Views/viewer Hooks** (`web-viewer/web/viewer-views/viewer-hooks`): 5 files, cohesion 0.6, coupling 0.4
- **Web Viewer/web/viewer Views/viewer Views** (`web-viewer/web/viewer-views/viewer-views`): 5 files, cohesion 0.67, coupling 0.33
