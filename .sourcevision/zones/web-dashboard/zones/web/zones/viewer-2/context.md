...
Cross-dependencies between sub-zones:
  web-viewer/web/viewer-2/prune → web-viewer/web/viewer-2/viewer-components: 5
  web-viewer/web/viewer-2/viewer → web-viewer/web/viewer-2/viewer-components: 6
  web-viewer/web/viewer-2/viewer-components → web-viewer/web/viewer-2/prune: 1
...
- **Web Viewer/web/viewer 2/prune** (`web-viewer/web/viewer-2/prune`): 3 files, cohesion 0.29, coupling 0.71
- **Web Viewer/web/viewer 2/viewer** (`web-viewer/web/viewer-2/viewer`): 6 files, cohesion 0.25, coupling 0.75
- **Web Viewer/web/viewer 2/viewer Components** (`web-viewer/web/viewer-2/viewer-components`): 45 files, cohesion 0.92, coupling 0.08
