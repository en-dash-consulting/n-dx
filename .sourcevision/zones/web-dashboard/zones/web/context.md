...
Files: 286, Cohesion: 0.95, Coupling: 0.05
Description: 286 files, primarily TypeScript
Entry points: packages/web/src/schema/v1.ts, packages/web/src/server/rex-gateway.ts, packages/web/src/server/types.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/sidebar.ts, packages/web/src/viewer/hooks/use-polling.ts, packages/web/src/viewer/messaging/index.ts, packages/web/src/viewer/performance/index.ts, packages/web/src/viewer/polling/index.ts, packages/web/src/viewer/polling/polling-state.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts, packages/web/src/viewer/visualization/index.ts
Lines: 91506
...
Cross-dependencies between sub-zones:
  ...
  web-viewer/web/unit-2 → web-viewer/web/viewer: 4
  web-viewer/web/unit-2 → web-viewer/web/viewer-2: 1
  web-viewer/web/unit-2 → web-viewer/web/viewer-components: 6
  web-viewer/web/viewer → web-viewer/web/unit: 3
  web-viewer/web/viewer → web-viewer/web/unit-2: 7
  web-viewer/web/viewer → web-viewer/web/viewer-2: 4
  web-viewer/web/viewer → web-viewer/web/viewer-3: 2
  web-viewer/web/viewer → web-viewer/web/viewer-components: 8
  web-viewer/web/viewer-2 → web-viewer/web/unit-viewer: 1
  web-viewer/web/viewer-2 → web-viewer/web/viewer: 6
  web-viewer/web/viewer-2 → web-viewer/web/viewer-3: 3
  web-viewer/web/viewer-2 → web-viewer/web/viewer-components: 1
  web-viewer/web/viewer-3 → web-viewer/web/viewer: 1
  web-viewer/web/viewer-3 → web-viewer/web/viewer-2: 7
  web-viewer/web/viewer-components → web-viewer/web/unit-2: 7
  web-viewer/web/viewer-components → web-viewer/web/unit-viewer: 2
...
- **Web Viewer/web/unit** (`web-viewer/web/unit`): 72 files, cohesion 0.96, coupling 0.04
  - Has 4 nested sub-zone(s)
- **Web Viewer/web/unit 2** (`web-viewer/web/unit-2`): 28 files, cohesion 0.56, coupling 0.44
- **Web Viewer/web/unit Viewer** (`web-viewer/web/unit-viewer`): 16 files, cohesion 0.85, coupling 0.15
- **Web Viewer/web/viewer** (`web-viewer/web/viewer`): 86 files, cohesion 0.88, coupling 0.12
...
- **Web Viewer/web/viewer Components** (`web-viewer/web/viewer-components`): 15 files, cohesion 0.49, coupling 0.51
