# Web Viewer/web 2/web Unit — Zone Context

<!-- Per-zone context generated by Sourcevision. -->

<zone>

Zone: Web Viewer/web 2/web Unit (`web-viewer/web-2/web-unit`)
Files: 19, Cohesion: 0.45, Coupling: 0.55
Description: 19 files, primarily TypeScript
Entry points: packages/web/src/viewer/hooks/use-graceful-degradation.ts, packages/web/src/viewer/performance/dom-update-gate.ts, packages/web/src/viewer/performance/graceful-degradation.ts, packages/web/src/viewer/performance/response-buffer-gate.ts, packages/web/src/viewer/polling/polling-manager.ts, packages/web/src/viewer/polling/tab-visibility.ts
Lines: 7330
