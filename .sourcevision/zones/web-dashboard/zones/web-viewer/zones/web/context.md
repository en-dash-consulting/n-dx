...
Files: 76, Cohesion: 0.91, Coupling: 0.09
Description: 76 files, primarily TypeScript
Entry points: packages/web/src/viewer/components/breadcrumb.ts, packages/web/src/viewer/components/copy-link-button.ts, packages/web/src/viewer/components/detail-panel.ts, packages/web/src/viewer/components/favicon.ts, packages/web/src/viewer/components/logos.ts, packages/web/src/viewer/components/rex-task-link.ts, packages/web/src/viewer/external.ts, packages/web/src/viewer/hooks/use-app-data.ts, packages/web/src/viewer/hooks/use-route-state.ts, packages/web/src/viewer/types.ts, packages/web/src/viewer/utils.ts, packages/web/src/viewer/views/sourcevision-tabs.ts, packages/web/src/viewer/views/view-registry.ts, packages/web/src/viewer/visualization/index.ts
Lines: 18850
...
Cross-dependencies between sub-zones:
  ...
  web-viewer/web-viewer/web/viewer → web-viewer/web-viewer/web/viewer-components: 1
  web-viewer/web-viewer/web/viewer-2 → web-viewer/web-viewer/web/viewer: 9
  web-viewer/web-viewer/web/viewer-components → web-viewer/web-viewer/web/viewer: 5
  web-viewer/web-viewer/web/viewer-hooks → web-viewer/web-viewer/web/viewer: 6
  web-viewer/web-viewer/web/viewer-views → web-viewer/web-viewer/web/viewer: 14
  web-viewer/web-viewer/web/viewer-views → web-viewer/web-viewer/web/viewer-2: 3
  web-viewer/web-viewer/web/viewer-views → web-viewer/web-viewer/web/viewer-components: 1
...
- **Web Viewer/web Viewer/web/viewer** (`web-viewer/web-viewer/web/viewer`): 53 files, cohesion 0.82, coupling 0.18
- **Web Viewer/web Viewer/web/viewer 2** (`web-viewer/web-viewer/web/viewer-2`): 4 files, cohesion 0.32, coupling 0.68
- **Web Viewer/web Viewer/web/viewer Components** (`web-viewer/web-viewer/web/viewer-components`): 9 files, cohesion 0.72, coupling 0.28
- **Web Viewer/web Viewer/web/viewer Hooks** (`web-viewer/web-viewer/web/viewer-hooks`): 5 files, cohesion 0.55, coupling 0.45
- **Web Viewer/web Viewer/web/viewer Views** (`web-viewer/web-viewer/web/viewer-views`): 5 files, cohesion 0.31, coupling 0.69
